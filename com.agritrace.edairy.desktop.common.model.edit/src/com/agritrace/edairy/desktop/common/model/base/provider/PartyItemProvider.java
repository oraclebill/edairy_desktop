...
/**
 * This is the item provider adapter for a {@link com.agritrace.edairy.desktop.common.model.base.Party} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartyItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPartyIdPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Party Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPartyIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Party_partyId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Party_partyId_feature", "_UI_Party_type"),
				 ModelPackage.Literals.PARTY__PARTY_ID,
				 true,
				 false,
				 false,
	...
	protected void addPhoneNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Party_phoneNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Party_phoneNumber_feature", "_UI_Party_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.PARTY__LOCATION);
			childrenFeatures.add(ModelPackage.Literals.PARTY__CONTACT_METHODS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.PARTY__LOCATION,
				 ModelFactory.eINSTANCE.createLocation()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.PARTY__CONTACT_METHODS,
				 ModelFactory.eINSTANCE.createContactMethod()));
	}
