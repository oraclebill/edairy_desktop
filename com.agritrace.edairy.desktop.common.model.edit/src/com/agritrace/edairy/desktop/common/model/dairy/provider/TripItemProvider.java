...
/**
 * This is the item provider adapter for a {@link com.agritrace.edairy.desktop.common.model.dairy.Trip} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TripItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trip_collections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trip_collections_feature", "_UI_Trip_type"),
				 DairyPackage.Literals.TRIP__COLLECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDeliveriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trip_deliveries_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trip_deliveries_feature", "_UI_Trip_type"),
				 DairyPackage.Literals.TRIP__DELIVERIES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStartedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trip_started_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trip_started_feature", "_UI_Trip_type"),
				 DairyPackage.Literals.TRIP__STARTED,
				 true,
				 false,
				 false,
	...
	protected void addEndedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trip_ended_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trip_ended_feature", "_UI_Trip_type"),
				 DairyPackage.Literals.TRIP__ENDED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Date labelValue = ((Trip)object).getStarted();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_Trip_type") :
