...
/**
 * This is the item provider adapter for a {@link com.agritrace.edairy.desktop.common.model.dairy.Membership} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAccountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Membership_account_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Membership_account_feature", "_UI_Membership_type"),
				 DairyPackage.Literals.MEMBERSHIP__ACCOUNT,
				 true,
				 false,
				 true,
				 null,
