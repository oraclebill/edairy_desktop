...
public class SupplierListView extends SubModuleView {
	...
	final SupplierInfoMDComposite mdComposite = new SupplierInfoMDComposite(result, SWT.NONE);
	...
	txtDep.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false, 2, 1));

	GridDataFactory.swtDefaults().align(PROP_TITLE, PROP_TITLE).span(1, 3).hint(SWT.DEFAULT, 40)
		.applyTo(UIControlsFactory.createLabel(detailGroup, "Decription")); //$NON-NLS-1$
	final Text description = UIControlsFactory.createTextMultiWrap(detailGroup, false, true);
	...
	txtFirst.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
