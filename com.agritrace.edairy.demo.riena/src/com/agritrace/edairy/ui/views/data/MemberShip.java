...
public class MemberShip extends Staff {
    ...
    public MemberShip(String lastname, String firstname) {
	...
	final int oldCrdit = credit;
	this.crdit = credit;
	firePropertyChanged(PROPERTY_CREDIT, Integer.valueOf(oldCrdit), Integer.valueOf(credit));
    }
