...
public class LocalDairyView extends SubModuleView {
    ...
    public static final String ID = LocalDairyView.class.getName();

    public LocalDairyView() {
    }
	...
	final Group result = UIControlsFactory.createGroup(parent, "Local Dairy Information:"); //$NON-NLS-1$
	...
	photoImage = new Image(parent.getDisplay(), photoImage.getImageData().scaledTo(48, 48));
