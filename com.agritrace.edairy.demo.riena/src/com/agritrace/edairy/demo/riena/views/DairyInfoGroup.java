...
import com.agritrace.edairy.demo.riena.EDairyManagerApplication;

public class DairyInfoGroup extends Composite {
	private Text txtName;
	private Text txtId;
	private Text txtLicense;
	private Text txtEstablishedAs;
	private Text txtJohnJones;
	private Text text_1;
	 ...
	 * @param style
	 */
	public DairyInfoGroup(Composite parent, int style) {
		super(parent, SWT.NO_BACKGROUND);
		setLayout(new FormLayout());
		
		// Construct Dairy Name/ID Area
		Group nameArea = new Group(this, SWT.NONE);
		nameArea.setText("General Information");

		// Construct Dairy Image
		CLabel lblDairyImage = new CLabel(this, SWT.NONE);
		lblDairyImage.setImage(ImageStore.getInstance().getImage("map.jpg"));

		// Construct Dairy Location Component
//		LocationInfoGroup locationInfoGroup = new LocationInfoGroup(this, SWT.NONE);
		Composite locationInfoGroup = new Group(this, SWT.NONE);
