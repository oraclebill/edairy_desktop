...
public class ServiceRequestResourceManager {
	...
	private static final String FILE_PATH="c:/temp/eDairy/servicerequests.xml";
	...
	public void createServiceRequestsResource() throws ParseException {
		URI farmResourceURI = URI
				.createFileURI(FILE_PATH);
...
//		URI dairyResourceURI = URI
//				.createFileURI("c:/temp/eDairy/dairyDB.dairy");
//
...
//		PostalLocation pLocation2 = ModelFactory.eINSTANCE
//				.createPostalLocation();
...
//		PostalLocation pLocation3 = ModelFactory.eINSTANCE
//				.createPostalLocation();
