...
public class MemberStatementReportView extends ViewPart {
	...
	public static final String ID = MemberStatementReportView.class.getName(); 

	public MemberStatementReportView() {
	}
	...
	public void createPartControl(Composite parent) {
		...
		label.setImage(ResourceManager.getPluginImage("com.agritrace.edairy.demo.riena", "resources/reports/eDairyReport-farmerstatement.jpg"));
