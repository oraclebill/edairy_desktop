...
public class RouteListDialog extends AbstractDialogView {
	...
	protected Control buildView(Composite parent) {
		...
		Table routeTable = UIControlsFactory.createTable(contentArea, SWT.SINGLE | SWT.BORDER | SWT.FULL_SELECTION, RouteListDialogController.RIDGET_ID_ROUTE_TABLE);
		...
		Button addButton = UIControlsFactory.createButton(contentArea, "Add", RouteListDialogController.RIDGET_ID_ADD);
		gd = new GridData();
		gd.widthHint = WIDTH_UNIT;
		addButton.setLayoutData(gd);
		
		Button deleteButton = UIControlsFactory.createButton(contentArea, "Delete", RouteListDialogController.RIDGET_ID_DELETE);
		gd = new GridData();
		gd.widthHint = WIDTH_UNIT;
		deleteButton.setLayoutData(gd);

		Button closeButton = UIControlsFactory.createButton(contentArea, "Close", RouteListDialogController.RIDGET_ID_CLOSE);
		gd = new GridData();
