...
public class VehicleMasterDetailComposite extends MasterDetailsComposite {
	...
	private void createIdentificationControls(Composite parent) {
		...
		addUIControl(logNumber, BIND_ID_LOG_NUM); //$NON-NLS-1$

		UIControlsFactory.createLabel(comonComp, "Driver"); //$NON-NLS-1$
		Text driverText = UIControlsFactory.createText(comonComp);
		GridDataFactory.fillDefaults().grab(true, false).applyTo(driverText);
		addUIControl(driverText, BIND_ID_DRIVER_NAME); //$NON-NLS-1$
	...
	private void createRegistrationGroup(Composite parent) {
		Group detailGroup = UIControlsFactory.createGroup(parent,
				"Registration");
		detailGroup.setLayout(GridLayoutFactory.swtDefaults().numColumns(2)
				.create());
		...
		Text regText = UIControlsFactory.createText(detailGroup);
		...
		Text chassisText = UIControlsFactory.createText(detailGroup);
		...
		Text engineText = UIControlsFactory.createText(detailGroup);
	...
	private void createDescriptionGroup(Composite parent) {
		...
		Text makeText = UIControlsFactory.createText(detailGroup);
		...
		Text modelText = UIControlsFactory.createText(detailGroup);
		...
		Text colorText = UIControlsFactory.createText(detailGroup);
		...
		Text yearText = UIControlsFactory.createText(detailGroup);
		...
		Text compacityText = UIControlsFactory.createText(detailGroup);
	...
	private void createAssetInfoGroup(Composite parent) {
		...
		Text dateAcqText = UIControlsFactory.createText(detailGroup);
		...
		Text damageDateText = UIControlsFactory.createText(detailGroup);
		...
		Text damageDescText = UIControlsFactory.createTextMulti(detailGroup, true, true);
		...
		Text disposalDateText = UIControlsFactory.createText(detailGroup);
		...
		Text disposalReasonText = UIControlsFactory.createTextMulti(detailGroup, true, true);
		...
		Text witnessText = UIControlsFactory.createText(detailGroup);
