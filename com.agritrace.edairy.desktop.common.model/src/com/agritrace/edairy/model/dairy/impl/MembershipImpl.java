 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getMemberId
 * <em>Member Id</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getApplicationDate
 * <em>Application Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getEffectiveDate
 * <em>Effective Date</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getStatus
 * <em>Status</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getDefaultRoute
 * <em>Default Route</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getMember
 * <em>Member</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.MembershipImpl#getFarms <em>
 * Farms</em>}</li>
 * </ul>
 * </p>
 * 
...
public class MembershipImpl extends EObjectImpl implements Membership {
    /**
     * The default value of the '{@link #getMemberId() <em>Member Id</em>}'
    ...
    /**
     * The cached value of the '{@link #getMemberId() <em>Member Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getMemberId()
     * @generated
    ...
    /**
     * The default value of the '{@link #getApplicationDate()
     * <em>Application Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getApplicationDate()
     * <em>Application Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getApplicationDate()
    ...
    /**
     * The default value of the '{@link #getEffectiveDate()
     * <em>Effective Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getEffectiveDate()
     * <em>Effective Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getEffectiveDate()
    ...
    /**
     * The cached value of the '{@link #getDefaultRoute()
     * <em>Default Route</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDefaultRoute()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getFarms() <em>Farms</em>}' reference
	...
	final String oldMemberId = memberId;
	memberId = newMemberId;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.MEMBERSHIP__MEMBER_ID, oldMemberId,
		    memberId));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.MEMBERSHIP__APPLICATION_DATE,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.MEMBERSHIP__EFFECTIVE_DATE,
	...
	if (defaultRoute != null && defaultRoute.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.MEMBERSHIP__DEFAULT_ROUTE,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.MEMBERSHIP__DEFAULT_ROUTE,
		    oldDefaultRoute, defaultRoute));
	}
    }
	...
	final Person oldMember = member;
	member = newMember;
	if (eNotificationRequired()) {
	    final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    DairyPackage.MEMBERSHIP__MEMBER, oldMember, newMember);
	    if (msgs == null) {
		msgs = notification;
	    } else {
	...
	if (newMember != member) {
	    ...
	    if (member != null) {
		msgs = ((InternalEObject) member).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
			- DairyPackage.MEMBERSHIP__MEMBER, null, msgs);
	    }
	    if (newMember != null) {
		msgs = ((InternalEObject) newMember).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
			- DairyPackage.MEMBERSHIP__MEMBER, null, msgs);
	    }
	...
	case DairyPackage.MEMBERSHIP__APPLICATION_DATE:
	    return APPLICATION_DATE_EDEFAULT == null ? applicationDate != null : !APPLICATION_DATE_EDEFAULT
		    .equals(applicationDate);
	case DairyPackage.MEMBERSHIP__EFFECTIVE_DATE:
	    return EFFECTIVE_DATE_EDEFAULT == null ? effectiveDate != null : !EFFECTIVE_DATE_EDEFAULT
