 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.RouteImpl#getId <em>Id</em>}
 * </li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.RouteImpl#getName <em>Name
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.RouteImpl#getStops <em>Stops
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.RouteImpl#getCode <em>Code
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.RouteImpl#getDescription
...
public class RouteImpl extends EObjectImpl implements Route {
	...
	return DairyPackage.Literals.ROUTE;
    }
	...
	name = newName;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ROUTE__NAME, oldName, name));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ROUTE__DESCRIPTION, oldDescription,
		    description));
	}
    }
