 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getLineNumber
 * <em>Line Number</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getRecordedMember
 * <em>Recorded Member</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getQuantity
 * <em>Quantity</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#isFlagged
 * <em>Flagged</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getUnitOfMeasure
 * <em>Unit Of Measure</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#isNotRecorded
 * <em>Not Recorded</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getValidatedMember
 * <em>Validated Member</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#isOffRoute
 * <em>Off Route</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getFrom
 * <em>From</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getFarmContainer
 * <em>Farm Container</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getDairyContainer
 * <em>Dairy Container</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#getCollectionJournal
 * <em>Collection Journal</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalLineImpl#isRejected
 * <em>Rejected</em>}</li>
 * </ul>
 * </p>
 * 
...
public class CollectionJournalLineImpl extends EObjectImpl implements CollectionJournalLine {
    ...
    /**
     * The default value of the '{@link #getRecordedMember()
    ...
    /**
     * The cached value of the '{@link #getRecordedMember()
     * <em>Recorded Member</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getRecordedMember()
    ...
    /**
     * The default value of the '{@link #isFlagged() <em>Flagged</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isFlagged()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isFlagged() <em>Flagged</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isFlagged()
     * @generated
    ...
    /**
     * The default value of the '{@link #getUnitOfMeasure()
    ...
    /**
     * The cached value of the '{@link #getUnitOfMeasure()
     * <em>Unit Of Measure</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getUnitOfMeasure()
    ...
    /**
     * The default value of the '{@link #isNotRecorded() <em>Not Recorded</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isNotRecorded()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isNotRecorded() <em>Not Recorded</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isNotRecorded()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getValidatedMember()
    ...
    /**
     * The default value of the '{@link #isOffRoute() <em>Off Route</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isOffRoute()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isOffRoute() <em>Off Route</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isOffRoute()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getFarmContainer()
    ...
    /**
     * The cached value of the '{@link #getDairyContainer()
    ...
    /**
     * The cached value of the '{@link #getCollectionJournal()
    ...
    /**
     * The default value of the '{@link #isRejected() <em>Rejected</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isRejected()
     * @generated
    ...
    /**
     * The cached value of the '{@link #isRejected() <em>Rejected</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #isRejected()
     * @generated
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__LINE_NUMBER,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    DairyPackage.COLLECTION_JOURNAL_LINE__RECORDED_MEMBER, oldRecordedMember, recordedMember));
	}
    }
	...
	final double oldQuantity = quantity;
	quantity = newQuantity;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__QUANTITY,
	...
	flagged = newFlagged;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__FLAGGED,
		    oldFlagged, flagged));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    DairyPackage.COLLECTION_JOURNAL_LINE__UNIT_OF_MEASURE, oldUnitOfMeasure, unitOfMeasure));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__NOT_RECORDED,
		    oldNotRecorded, notRecorded));
	}
    }
	...
	if (validatedMember != null && validatedMember.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    DairyPackage.COLLECTION_JOURNAL_LINE__VALIDATED_MEMBER, oldValidatedMember, validatedMember));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__OFF_ROUTE,
		    oldOffRoute, offRoute));
	}
    }
	...
	if (from != null && from.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    DairyPackage.COLLECTION_JOURNAL_LINE__FROM, oldFrom, from));
		}
	    }
	}
	return from;
	...
	from = newFrom;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__FROM, oldFrom,
		    from));
	}
    }
	...
	if (farmContainer != null && farmContainer.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    DairyPackage.COLLECTION_JOURNAL_LINE__FARM_CONTAINER, oldFarmContainer, farmContainer));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__FARM_CONTAINER,
		    oldFarmContainer, farmContainer));
	}
    }
	...
	if (dairyContainer != null && dairyContainer.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    DairyPackage.COLLECTION_JOURNAL_LINE__DAIRY_CONTAINER, oldDairyContainer, dairyContainer));
		}
	    }
	}
	...
	final Container oldDairyContainer = dairyContainer;
	...
	if (collectionJournal != null && collectionJournal.eIsProxy()) {
	    final InternalEObject oldCollectionJournal = (InternalEObject) collectionJournal;
	    collectionJournal = (CollectionJournal) eResolveProxy(oldCollectionJournal);
	    if (collectionJournal != oldCollectionJournal) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    DairyPackage.COLLECTION_JOURNAL_LINE__COLLECTION_JOURNAL, oldCollectionJournal,
			    collectionJournal));
		}
	    }
	}
	...
	final CollectionJournal oldCollectionJournal = collectionJournal;
	collectionJournal = newCollectionJournal;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    DairyPackage.COLLECTION_JOURNAL_LINE__COLLECTION_JOURNAL, oldCollectionJournal, collectionJournal));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL_LINE__REJECTED,
	...
	case DairyPackage.COLLECTION_JOURNAL_LINE__RECORDED_MEMBER:
	    return RECORDED_MEMBER_EDEFAULT == null ? recordedMember != null : !RECORDED_MEMBER_EDEFAULT
		    .equals(recordedMember);
	case DairyPackage.COLLECTION_JOURNAL_LINE__QUANTITY:
