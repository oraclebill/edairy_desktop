 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.TripImpl#getCollections <em>
 * Collections</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.TripImpl#getDeliveries <em>
 * Deliveries</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.TripImpl#getStarted <em>
 * Started</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.TripImpl#getEnded <em>Ended
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class TripImpl extends EObjectImpl implements Trip {
    /**
     * The cached value of the '{@link #getCollections() <em>Collections</em>}'
    ...
    /**
     * The cached value of the '{@link #getDeliveries() <em>Deliveries</em>}'
     * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDeliveries()
     * @generated
	...
	if (collections == null) {
	    collections = new EObjectResolvingEList<CollectionJournal>(CollectionJournal.class, this,
		    DairyPackage.TRIP__COLLECTIONS);
	}
	return collections;
    }
	...
	if (deliveries == null) {
	    deliveries = new EObjectResolvingEList<DeliveryJournal>(DeliveryJournal.class, this,
		    DairyPackage.TRIP__DELIVERIES);
	}
	return deliveries;
    }
