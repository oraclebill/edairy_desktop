 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getRegistrationNumber
 * <em>Registration Number</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getType <em>Type
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getMake <em>Make
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getModel <em>
 * Model</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getEngineNumber
 * <em>Engine Number</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getChassisNumber
 * <em>Chassis Number</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getLogBookNumber
 * <em>Log Book Number</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getInsurancePolicyNumber
 * <em>Insurance Policy Number</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getInsuranceExpirationDate
 * <em>Insurance Expiration Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getDominantColour
 * <em>Dominant Colour</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getCapacityInTonnes
 * <em>Capacity In Tonnes</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getDriver <em>
 * Driver</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.VehicleImpl#getYear <em>Year
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class VehicleImpl extends AssetImpl implements Vehicle {
    ...
    /**
     * The default value of the '{@link #getEngineNumber()
    ...
    /**
     * The cached value of the '{@link #getEngineNumber()
     * <em>Engine Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getEngineNumber()
    ...
    /**
     * The default value of the '{@link #getChassisNumber()
    ...
    /**
     * The cached value of the '{@link #getChassisNumber()
     * <em>Chassis Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getChassisNumber()
    ...
    /**
     * The default value of the '{@link #getLogBookNumber()
    ...
    /**
     * The cached value of the '{@link #getLogBookNumber()
     * <em>Log Book Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getLogBookNumber()
    ...
    /**
     * The default value of the '{@link #getInsurancePolicyNumber()
    ...
    /**
     * The cached value of the '{@link #getInsurancePolicyNumber()
     * <em>Insurance Policy Number</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getInsurancePolicyNumber()
    ...
    /**
     * The default value of the '{@link #getInsuranceExpirationDate()
    ...
    /**
     * The cached value of the '{@link #getInsuranceExpirationDate()
     * <em>Insurance Expiration Date</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getInsuranceExpirationDate()
    ...
    /**
     * The default value of the '{@link #getDominantColour()
    ...
    /**
     * The cached value of the '{@link #getDominantColour()
     * <em>Dominant Colour</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDominantColour()
    ...
    /**
     * The default value of the '{@link #getCapacityInTonnes()
    ...
    /**
     * The cached value of the '{@link #getCapacityInTonnes()
     * <em>Capacity In Tonnes</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getCapacityInTonnes()
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__REGISTRATION_NUMBER,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__ENGINE_NUMBER, oldEngineNumber,
		    engineNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__CHASSIS_NUMBER,
		    oldChassisNumber, chassisNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__LOG_BOOK_NUMBER,
		    oldLogBookNumber, logBookNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__INSURANCE_POLICY_NUMBER,
		    oldInsurancePolicyNumber, insurancePolicyNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__INSURANCE_EXPIRATION_DATE,
		    oldInsuranceExpirationDate, insuranceExpirationDate));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__DOMINANT_COLOUR,
		    oldDominantColour, dominantColour));
	}
    }
	...
	final String oldCapacityInTonnes = capacityInTonnes;
	capacityInTonnes = newCapacityInTonnes;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.VEHICLE__CAPACITY_IN_TONNES,
		    oldCapacityInTonnes, capacityInTonnes));
	}
    }
	...
	if (driver != null && driver.eIsProxy()) {
	    ...
	    if (driver != oldDriver) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.VEHICLE__DRIVER, oldDriver,
			    driver));
		}
	    }
	}
	...
	case DairyPackage.VEHICLE__CHASSIS_NUMBER:
	    return CHASSIS_NUMBER_EDEFAULT == null ? chassisNumber != null : !CHASSIS_NUMBER_EDEFAULT
		    .equals(chassisNumber);
	case DairyPackage.VEHICLE__LOG_BOOK_NUMBER:
	    return LOG_BOOK_NUMBER_EDEFAULT == null ? logBookNumber != null : !LOG_BOOK_NUMBER_EDEFAULT
		    .equals(logBookNumber);
	case DairyPackage.VEHICLE__INSURANCE_POLICY_NUMBER:
	    return INSURANCE_POLICY_NUMBER_EDEFAULT == null ? insurancePolicyNumber != null
		    : !INSURANCE_POLICY_NUMBER_EDEFAULT.equals(insurancePolicyNumber);
	case DairyPackage.VEHICLE__INSURANCE_EXPIRATION_DATE:
	    return INSURANCE_EXPIRATION_DATE_EDEFAULT == null ? insuranceExpirationDate != null
		    : !INSURANCE_EXPIRATION_DATE_EDEFAULT.equals(insuranceExpirationDate);
	case DairyPackage.VEHICLE__DOMINANT_COLOUR:
	    return DOMINANT_COLOUR_EDEFAULT == null ? dominantColour != null : !DOMINANT_COLOUR_EDEFAULT
		    .equals(dominantColour);
	case DairyPackage.VEHICLE__CAPACITY_IN_TONNES:
	    return CAPACITY_IN_TONNES_EDEFAULT == null ? capacityInTonnes != null : !CAPACITY_IN_TONNES_EDEFAULT
		    .equals(capacityInTonnes);
	case DairyPackage.VEHICLE__DRIVER:
	    return driver != null;
	case DairyPackage.VEHICLE__YEAR:
