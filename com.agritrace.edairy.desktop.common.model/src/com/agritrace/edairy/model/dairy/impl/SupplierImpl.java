 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getSupplierId
 * <em>Supplier Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getCategories
 * <em>Categories</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getPublicDescription
 * <em>Public Description</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getStatus <em>
 * Status</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getRegistrationDate
 * <em>Registration Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getExpirationDate
 * <em>Expiration Date</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getNotes <em>
 * Notes</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getRating <em>
 * Rating</em>}</li>
 * </ul>
 * </p>
 * 
...
public class SupplierImpl extends PersonImpl implements Supplier {
    /**
     * The default value of the '{@link #getSupplierId() <em>Supplier Id</em>}'
    ...
    /**
     * The cached value of the '{@link #getSupplierId() <em>Supplier Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getSupplierId()
     * @generated
    ...
    /**
     * The default value of the '{@link #getPublicDescription()
    ...
    /**
     * The cached value of the '{@link #getPublicDescription()
     * <em>Public Description</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getPublicDescription()
    ...
    /**
     * The default value of the '{@link #getRegistrationDate()
    ...
    /**
     * The cached value of the '{@link #getRegistrationDate()
     * <em>Registration Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getRegistrationDate()
    ...
    /**
     * The default value of the '{@link #getExpirationDate()
    ...
    /**
     * The cached value of the '{@link #getExpirationDate()
     * <em>Expiration Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getExpirationDate()
    ...
    /**
     * The default value of the '{@link #getRating() <em>Rating</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRating()
     * @generated
	...
	final Long oldSupplierId = supplierId;
	supplierId = newSupplierId;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.SUPPLIER__SUPPLIER_ID, oldSupplierId,
		    supplierId));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.SUPPLIER__PUBLIC_DESCRIPTION,
		    oldPublicDescription, publicDescription));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.SUPPLIER__REGISTRATION_DATE,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.SUPPLIER__EXPIRATION_DATE,
	...
	case DairyPackage.SUPPLIER__PUBLIC_DESCRIPTION:
	    return PUBLIC_DESCRIPTION_EDEFAULT == null ? publicDescription != null : !PUBLIC_DESCRIPTION_EDEFAULT
		    .equals(publicDescription);
	case DairyPackage.SUPPLIER__STATUS:
	    return status != STATUS_EDEFAULT;
	case DairyPackage.SUPPLIER__REGISTRATION_DATE:
	    return REGISTRATION_DATE_EDEFAULT == null ? registrationDate != null : !REGISTRATION_DATE_EDEFAULT
		    .equals(registrationDate);
	case DairyPackage.SUPPLIER__EXPIRATION_DATE:
	    return EXPIRATION_DATE_EDEFAULT == null ? expirationDate != null : !EXPIRATION_DATE_EDEFAULT
