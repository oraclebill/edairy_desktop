 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getId <em>
 * Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getDateOpened
 * <em>Date Opened</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getPhone
 * <em>Phone</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getRoute
 * <em>Route</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getCode
 * <em>Code</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getLocation
 * <em>Location</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyLocationImpl#getFunctions
 * <em>Functions</em>}</li>
 * </ul>
 * </p>
 * 
...
public class DairyLocationImpl extends EObjectImpl implements DairyLocation {
    ...
    /**
     * The default value of the '{@link #getDateOpened() <em>Date Opened</em>}'
    ...
    /**
     * The cached value of the '{@link #getDateOpened() <em>Date Opened</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDateOpened()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getFunctions() <em>Functions</em>}'
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY_LOCATION__DATE_OPENED,
		    oldDateOpened, dateOpened));
	}
    }
	...
	if (route != null && route.eIsProxy()) {
	    ...
	    if (route != oldRoute) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.DAIRY_LOCATION__ROUTE,
			    oldRoute, route));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY_LOCATION__DESCRIPTION,
	...
	if (eNotificationRequired()) {
	    final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    DairyPackage.DAIRY_LOCATION__LOCATION, oldLocation, newLocation);
	    if (msgs == null) {
		msgs = notification;
	    } else {
	...
	if (newLocation != location) {
		...
		msgs = ((InternalEObject) location).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
			- DairyPackage.DAIRY_LOCATION__LOCATION, null, msgs);
	    }
	    if (newLocation != null) {
	    ...
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY_LOCATION__LOCATION, newLocation,
		    newLocation));
	}
    }
	...
	if (functions == null) {
	    functions = new EDataTypeUniqueEList<DairyFunction>(DairyFunction.class, this,
		    DairyPackage.DAIRY_LOCATION__FUNCTIONS);
	}
	return functions;
    }
