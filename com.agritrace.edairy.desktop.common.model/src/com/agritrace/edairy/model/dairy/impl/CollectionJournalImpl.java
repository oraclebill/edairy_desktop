 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getJournalEntries
 * <em>Journal Entries</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getReferenceNumber
 * <em>Reference Number</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getJournalDate
 * <em>Journal Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getSession
 * <em>Session</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getDriver
 * <em>Driver</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getRoute
 * <em>Route</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getFarmContainer
 * <em>Farm Container</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getBin
 * <em>Bin</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getVehicle
 * <em>Vehicle</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getDriverTotal
 * <em>Driver Total</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.CollectionJournalImpl#getRecordTotal
...
public class CollectionJournalImpl extends EObjectImpl implements CollectionJournal {
    ...
    /**
     * The default value of the '{@link #getReferenceNumber()
    ...
    /**
     * The cached value of the '{@link #getReferenceNumber()
     * <em>Reference Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getReferenceNumber()
    ...
    /**
     * The default value of the '{@link #getJournalDate() <em>Journal Date</em>}
    ...
    /**
     * The cached value of the '{@link #getJournalDate() <em>Journal Date</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getJournalDate()
     * @generated
    ...
    /**
     * The default value of the '{@link #getSession() <em>Session</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getSession()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getVehicle() <em>Vehicle</em>}'
    ...
    /**
     * The default value of the '{@link #getDriverTotal() <em>Driver Total</em>}
     * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDriverTotal()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDriverTotal() <em>Driver Total</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDriverTotal()
     * @generated
    ...
    /**
     * The default value of the '{@link #getRecordTotal() <em>Record Total</em>}
     * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRecordTotal()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getRecordTotal() <em>Record Total</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getRecordTotal()
     * @generated
	...
	if (journalEntries == null) {
	    journalEntries = new EObjectContainmentEList<CollectionJournalLine>(CollectionJournalLine.class, this,
		    DairyPackage.COLLECTION_JOURNAL__JOURNAL_ENTRIES);
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__REFERENCE_NUMBER,
		    oldReferenceNumber, referenceNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__JOURNAL_DATE,
		    oldJournalDate, journalDate));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__SESSION, oldSession,
		    session));
	}
    }
	...
	if (driver != null && driver.eIsProxy()) {
	    ...
	    if (driver != oldDriver) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.COLLECTION_JOURNAL__DRIVER,
			    oldDriver, driver));
		}
	    }
	}
	...
	driver = newDriver;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__DRIVER, oldDriver,
		    driver));
	}
    }
	...
	if (route != null && route.eIsProxy()) {
	    ...
	    if (route != oldRoute) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.COLLECTION_JOURNAL__ROUTE,
			    oldRoute, route));
		}
	    }
	}
	...
	route = newRoute;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__ROUTE, oldRoute,
		    route));
	}
    }
	...
	if (farmContainer != null && farmContainer.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    DairyPackage.COLLECTION_JOURNAL__FARM_CONTAINER, oldFarmContainer, farmContainer));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__FARM_CONTAINER,
	...
	if (bin != null && bin.eIsProxy()) {
	    ...
	    if (bin != oldBin) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.COLLECTION_JOURNAL__BIN,
			    oldBin, bin));
		}
	    }
	}
	...
	if (vehicle != null && vehicle.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.COLLECTION_JOURNAL__VEHICLE,
			    oldVehicle, vehicle));
		}
	    }
	}
	...
	vehicle = newVehicle;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__VEHICLE, oldVehicle,
		    vehicle));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__DRIVER_TOTAL,
		    oldDriverTotal, driverTotal));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.COLLECTION_JOURNAL__RECORD_TOTAL,
		    oldRecordTotal, recordTotal));
	}
    }
	...
	case DairyPackage.COLLECTION_JOURNAL__REFERENCE_NUMBER:
	    return REFERENCE_NUMBER_EDEFAULT == null ? referenceNumber != null : !REFERENCE_NUMBER_EDEFAULT
