...
public enum DairyFunction implements Enumerator {
    /**
     * The '<em><b>Milk Collection</b></em>' literal object. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>Milk Storage</b></em>' literal object. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>Store Sales</b></em>' literal object. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>Warehouse</b></em>' literal object. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #WAREHOUSE_VALUE
     * @generated
    ...
    /**
     * The '<em><b>Milk Processing</b></em>' literal object. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>Milk Collection</b></em>' literal value. <!-- begin-user-doc
     * -->
     * <p>
    ...
    /**
     * The '<em><b>Milk Storage</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * The '<em><b>Store Sales</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * The '<em><b>Warehouse</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * The '<em><b>Milk Processing</b></em>' literal value. <!-- begin-user-doc
     * -->
     * <p>
     ...
     * @generated
     */
    private static final DairyFunction[] VALUES_ARRAY = new DairyFunction[] { MILK_COLLECTION, MILK_STORAGE,
	    STORE_SALES, WAREHOUSE, MILK_PROCESSING, };

    /**
     * A public read-only list of all the '<em><b>Function</b></em>'
    ...
    /**
     * Returns the '<em><b>Function</b></em>' literal with the specified literal
	...
	for (int i = 0; i < VALUES_ARRAY.length; ++i) {
	    final DairyFunction result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>Function</b></em>' literal with the specified integer
     * value. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
	...
	switch (value) {
	case MILK_COLLECTION_VALUE:
	    return MILK_COLLECTION;
	case MILK_STORAGE_VALUE:
	    return MILK_STORAGE;
	case STORE_SALES_VALUE:
	    return STORE_SALES;
	case WAREHOUSE_VALUE:
	    return WAREHOUSE;
	case MILK_PROCESSING_VALUE:
	    return MILK_PROCESSING;
	}
	return null;
    }
