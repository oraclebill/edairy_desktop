 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getMemberId <em>Member
 * Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getApplicationDate
 * <em>Application Date</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getEffectiveDate <em>
 * Effective Date</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getStatus <em>Status
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getDefaultRoute <em>
 * Default Route</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getMember <em>Member
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.Membership#getFarms <em>Farms
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public interface Membership extends EObject {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Member Id</em>' attribute isn't clear, there
     ...
     * <em>Member Id</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
     *            the new value of the '<em>Member Id</em>' attribute.
     * @see #getMemberId()
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Application Date</em>' attribute.
     ...
     * 
     * @param value
     *            the new value of the '<em>Default Route</em>' reference.
     * @see #getDefaultRoute()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Farms</b></em>' reference list. The list
     * contents are of type {@link com.agritrace.edairy.model.tracking.Farm}.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Farms</em>' reference list isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
