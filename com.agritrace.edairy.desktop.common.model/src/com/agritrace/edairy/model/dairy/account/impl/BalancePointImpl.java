 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.account.impl.BalancePointImpl#getAccountBalanceId
 * <em>Account Balance Id</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.account.impl.BalancePointImpl#getAccount
 * <em>Account</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.account.impl.BalancePointImpl#getPreviousBalance
 * <em>Previous Balance</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.account.impl.BalancePointImpl#getAsOf
 * <em>As Of</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.account.impl.BalancePointImpl#getAmount
 * <em>Amount</em>}</li>
 * </ul>
 * </p>
 * 
...
public class BalancePointImpl extends EObjectImpl implements BalancePoint {
    /**
     * The default value of the '{@link #getAccountBalanceId()
    ...
    /**
     * The cached value of the '{@link #getAccountBalanceId()
     * <em>Account Balance Id</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getAccountBalanceId()
    ...
    /**
     * The cached value of the '{@link #getPreviousBalance()
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, AccountPackage.BALANCE_POINT__ACCOUNT_BALANCE_ID,
		    oldAccountBalanceId, accountBalanceId));
	}
    }
	...
	if (account != null && account.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccountPackage.BALANCE_POINT__ACCOUNT,
			    oldAccount, account));
		}
	    }
	}
	...
	account = newAccount;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, AccountPackage.BALANCE_POINT__ACCOUNT, oldAccount,
		    account));
	}
    }
	...
	if (previousBalance != null && previousBalance.eIsProxy()) {
	    final InternalEObject oldPreviousBalance = (InternalEObject) previousBalance;
	    previousBalance = (BalancePoint) eResolveProxy(oldPreviousBalance);
	    if (previousBalance != oldPreviousBalance) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    AccountPackage.BALANCE_POINT__PREVIOUS_BALANCE, oldPreviousBalance, previousBalance));
		}
	    }
	}
	...
	final BalancePoint oldPreviousBalance = previousBalance;
	previousBalance = newPreviousBalance;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, AccountPackage.BALANCE_POINT__PREVIOUS_BALANCE,
		    oldPreviousBalance, previousBalance));
	}
    }
	...
	amount = newAmount;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, AccountPackage.BALANCE_POINT__AMOUNT, oldAmount,
		    amount));
	}
    }
