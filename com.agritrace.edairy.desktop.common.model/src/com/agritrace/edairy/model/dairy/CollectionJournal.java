...
public interface CollectionJournal extends EObject {
    /**
     * Returns the value of the '<em><b>Journal Entries</b></em>' containment
     * reference list. The list contents are of type
     * {@link com.agritrace.edairy.model.dairy.CollectionJournalLine}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Journal Entries</em>' containment reference
     * list isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Journal Entries</em>' containment reference
     *         list.
     ...
     * <em>Session</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
     *            the new value of the '<em>Session</em>' attribute.
     * @see com.agritrace.edairy.model.dairy.Session
     * @see #getSession()
     * @generated
     */
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Driver</em>' reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * <em>Driver</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
     *            the new value of the '<em>Driver</em>' reference.
     * @see #getDriver()
     * @generated
     */
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Route</em>' reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Bin</em>' reference isn't clear, there really
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Vehicle</em>' reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     ...
     * <em>Vehicle</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @param value
