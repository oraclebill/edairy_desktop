...
public class DairyAdapterFactory extends AdapterFactoryImpl {
     ...
     * <em>Collection Journal Line</em>}'. <!-- begin-user-doc --> This default
     ...
     * <em>Collection Journal</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
     ...
     * <em>Delivery Journal</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     * 
