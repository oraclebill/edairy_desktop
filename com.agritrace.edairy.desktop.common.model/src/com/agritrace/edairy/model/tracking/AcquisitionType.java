...
public enum AcquisitionType implements Enumerator {
    /**
     * The '<em><b>BIRTH</b></em>' literal object. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #BIRTH_VALUE
     * @generated
    ...
    /**
     * The '<em><b>PURCHASE</b></em>' literal object. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #PURCHASE_VALUE
     * @generated
    ...
    /**
     * The '<em><b>BIRTH</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * The '<em><b>PURCHASE</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
     ...
     * @generated
     */
    private static final AcquisitionType[] VALUES_ARRAY = new AcquisitionType[] { BIRTH, PURCHASE, OTHER, };

    /**
     * A public read-only list of all the '<em><b>Acquisition Type</b></em>'
    ...
    /**
     * Returns the '<em><b>Acquisition Type</b></em>' literal with the specified
	...
	for (int i = 0; i < VALUES_ARRAY.length; ++i) {
	    final AcquisitionType result = VALUES_ARRAY[i];
