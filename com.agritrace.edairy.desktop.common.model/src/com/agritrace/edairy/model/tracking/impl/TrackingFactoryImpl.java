...
public class TrackingFactoryImpl extends EFactoryImpl implements TrackingFactory {
	...
	try {
	    final TrackingFactory theTrackingFactory = (TrackingFactory) EPackage.Registry.INSTANCE
		    .getEFactory("http://com.agritrace.edairy.model/tracking/");
	...
	case TrackingPackage.REGISTERED_ANIMAL:
	    return createRegisteredAnimal();
	case TrackingPackage.REFERENCE_ANIMAL_TYPE:
	    return createReferenceAnimalType();
	case TrackingPackage.ANIMAL_IDENTIFIER:
	    return createAnimalIdentifier();
	default:
