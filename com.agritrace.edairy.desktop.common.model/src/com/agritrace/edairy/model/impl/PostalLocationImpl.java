 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getAddress <em>
 * Address</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getSection <em>
 * Section</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getEstate <em>
 * Estate</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getVillage <em>
 * Village</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getSubLocation
 * <em>Sub Location</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getLocation
 * <em>Location</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getDistrict
 * <em>District</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getDivision
 * <em>Division</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getProvince
 * <em>Province</em>}</li>
 * <li>{@link com.agritrace.edairy.model.impl.PostalLocationImpl#getPostalCode
 * <em>Postal Code</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PostalLocationImpl extends EObjectImpl implements PostalLocation {
    ...
    /**
     * The default value of the '{@link #getEstate() <em>Estate</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getEstate()
     * @generated
    ...
    /**
     * The default value of the '{@link #getVillage() <em>Village</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getVillage()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getVillage() <em>Village</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getVillage()
     * @generated
    ...
    /**
     * The default value of the '{@link #getSubLocation() <em>Sub Location</em>}
     * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getSubLocation()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getSubLocation() <em>Sub Location</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getSubLocation()
     * @generated
    ...
    /**
     * The default value of the '{@link #getDistrict() <em>District</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDistrict()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDistrict() <em>District</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDistrict()
     * @generated
    ...
    /**
     * The default value of the '{@link #getDivision() <em>Division</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDivision()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDivision() <em>Division</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDivision()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getProvince() <em>Province</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getProvince()
     * @generated
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__ADDRESS, oldAddress,
		    address));
	}
    }
	...
	section = newSection;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__SECTION, oldSection,
		    section));
	}
    }
	...
	estate = newEstate;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__ESTATE, oldEstate,
		    estate));
	}
    }
	...
	village = newVillage;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__VILLAGE, oldVillage,
		    village));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__SUB_LOCATION,
		    oldSubLocation, subLocation));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__LOCATION, oldLocation,
		    location));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__DISTRICT, oldDistrict,
		    district));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__DIVISION, oldDivision,
		    division));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__PROVINCE, oldProvince,
		    province));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.POSTAL_LOCATION__POSTAL_CODE,
