...
public class RequestsFactoryImpl extends EFactoryImpl implements RequestsFactory {
	...
	try {
	    final RequestsFactory theRequestsFactory = (RequestsFactory) EPackage.Registry.INSTANCE
		    .getEFactory("http://edairy.agritrace.com/requests/");
	...
	case RequestsPackage.ANIMAL_HEALTH_REQUEST:
	    return createAnimalHealthRequest();
	default:
