...
public class RequestsAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected RequestsSwitch<Adapter> modelSwitch = new RequestsSwitch<Adapter>() {
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link com.agritrace.edairy.model.requests.AnimalHealthRequest <em>Animal Health Request</em>}'.
