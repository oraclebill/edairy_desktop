 ...
 * $Id$
 */
package com.agritrace.edairy.desktop.common.model.audit.util;
...
public class AuditAdapterFactory extends AdapterFactoryImpl {
	...
	protected AuditSwitch<Adapter> modelSwitch =
		new AuditSwitch<Adapter>() {
			@Override
			public Adapter caseAuditRecord(AuditRecord object) {
				return createAuditRecordAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.agritrace.edairy.desktop.common.model.audit.AuditRecord <em>Record</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAuditRecordAdapter() {
		return null;
	}
