...
public class AuditSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AuditPackage.AUDIT_RECORD: {
				AuditRecord auditRecord = (AuditRecord)theEObject;
				T result = caseAuditRecord(auditRecord);
	 ...
	 * @generated
	 */
	public T caseAuditRecord(AuditRecord object) {
		return null;
	}
