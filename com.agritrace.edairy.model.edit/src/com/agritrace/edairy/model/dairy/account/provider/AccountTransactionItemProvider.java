...
/**
 * This is the item provider adapter for a {@link com.agritrace.edairy.model.dairy.account.AccountTransaction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccountTransactionItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSourePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountTransaction_transactionId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountTransaction_transactionId_feature", "_UI_AccountTransaction_type"),
	...
	protected void addAccountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountTransaction_account_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountTransaction_account_feature", "_UI_AccountTransaction_type"),
	...
	protected void addTransactionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountTransaction_transactionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountTransaction_transactionType_feature", "_UI_AccountTransaction_type"),
	...
	/**
	 * This adds a property descriptor for the Soure feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSourePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountTransaction_soure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountTransaction_soure_feature", "_UI_AccountTransaction_type"),
				 AccountPackage.Literals.ACCOUNT_TRANSACTION__SOURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountTransaction_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountTransaction_description_feature", "_UI_AccountTransaction_type"),
	...
	protected void addTransactionDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AccountTransaction_transactionDate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AccountTransaction_transactionDate_feature", "_UI_AccountTransaction_type"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_AccountTransaction_type") + " " + accountTransaction.getTransactionId();
	}
