...
public class VehicleLogDetailComposite extends Composite {
		...
		private void createIdentificationControls(Composite parent) {
			...
			final Text logNumber = UIControlsFactory.createText(comonComp, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_LOG_NUM);
...
//			addUIControl(logNumber, BIND_ID_LOG_NUM);
			...
			final Text driverText = UIControlsFactory.createText(comonComp, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_DRIVER_NAME);
...
//			addUIControl(driverText, BIND_ID_DRIVER_NAME);
		...
		private void createRegistrationGroup(Composite parent) {
			...
			final Text regText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_REG_NUM);
...
//			addUIControl(regText, BIND_ID_REG_NUM);
			...
			final Text chassisText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_CHASSIS_NUM);
...
//			addUIControl(chassisText, BIND_ID_CHASSIS_NUM);
			...
			final Text engineText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_ENGINE_NUM);
...
//			addUIControl(engineText, BIND_ID_ENGINE_NUM);
		...
		private void createDescriptionGroup(Composite parent) {
			...
			final Text makeText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_DESC_MAKE);
...
//			addUIControl(makeText, BIND_ID_DESC_MAKE);
			...
			final Text modelText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_DESC_MODEL);
...
//			addUIControl(modelText, BIND_ID_DESC_MODEL);
			...
			final Text colorText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_DESC_COLOR);
...
//			addUIControl(colorText, BIND_ID_DESC_COLOR);
			...
			final Text yearText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_DESC_YEAR);
...
//			addUIControl(yearText, BIND_ID_DESC_YEAR);
			...
			final Text compacityText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_DESC_CAPACITY);
...
//			addUIControl(compacityText, BIND_ID_DESC_CAPACITY);
		...
		private void createAssetInfoGroup(Composite parent) {
			...
			final Text dateAcqText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_ASSET_DATE_ACQUIRED);
...
//			addUIControl(dateAcqText, BIND_ID_ASSET_DATE_ACQUIRED);
			...
			final Text damageDateText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_ASSET_DATE_DAMAGE);
...
//			addUIControl(damageDateText, BIND_ID_ASSET_DATE_DAMAGE);
			...
			final Text damageDescText = UIControlsFactory.createTextMulti(detailGroup, true, true, VehicleLogDetailBindConstants.BIND_ID_ASSET_DESC_DAMAGE);
...
//			addUIControl(damageDescText, BIND_ID_ASSET_DESC_DAMAGE);
			...
			final Text disposalDateText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_ASSET_DATE_DISPOSAL);
...
//			addUIControl(disposalDateText, BIND_ID_ASSET_DATE_DISPOSAL);
			...
			final Text disposalReasonText = UIControlsFactory.createTextMulti(detailGroup, true, true, VehicleLogDetailBindConstants.BIND_ID_ASSET_REASON_DISPOSAL);
...
//			addUIControl(disposalReasonText, BIND_ID_ASSET_REASON_DISPOSAL);
			...
			final Text witnessText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_ASSET_WITNESS_DISPOSAL);
...
//			addUIControl(witnessText, BIND_ID_ASSET_WITNESS_DISPOSAL);
		...
		private void createInsuranceInfoGroup(Composite parent) {
			...
			final Text dateAcqText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_INSURANCE_NUMBER);
			GridDataFactory.fillDefaults().grab(true, false).applyTo(dateAcqText);
//			addUIControl(dateAcqText, BIND_ID_INSURANCE_NUMBER);

			// Expiration Date
			UIControlsFactory.createLabel(detailGroup, "Expiration Date"); //$NON-NLS-1$
			final Text damageDateText = UIControlsFactory.createText(detailGroup, SWT.NONE, VehicleLogDetailBindConstants.BIND_ID_INSURANCE_EXP_DATE);
			GridDataFactory.fillDefaults().grab(true, false).applyTo(damageDateText);
