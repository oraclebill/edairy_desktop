...
//		new Entry(TRANSACTION_DATE , DairyPackage.Literals.C ),
		new Entry(TRANSACTION_TIME , DairyPackage.Literals.SCALE_IMPORT_RECORD__COLLECTION_TIME ),
//		new Entry(DAIRY_CODE , DairyPackage.Literals.SCALE ),
		new Entry(SCALE_SERIAL , DairyPackage.Literals.SCALE_IMPORT_RECORD__SCALE_SERIAL ),
		new Entry(OPERATOR_CODE , DairyPackage.Literals.SCALE ),
		new Entry(TRIP_NUMBER , DairyPackage.Literals.SCALE ),
		new Entry(SESSION_CODE , DairyPackage.Literals.SCALE ),
		new Entry(ROUTE_NUMBER , DairyPackage.Literals.SCALE ),
		new Entry(CENTER_NUMBER , DairyPackage.Literals.SCALE ),
		new Entry(MEMBER_NUMBER , DairyPackage.Literals.SCALE ),
		new Entry(QUANTITY , DairyPackage.Literals.SCALE ),
		new Entry(NUM_CANS , DairyPackage.Literals.SCALE ),
		new Entry(SCALE_TOTAL , DairyPackage.Literals.SCALE ),
		new Entry(ATTR_COUNT , DairyPackage.Literals.SCALE ),
	};
