...
public class SampleView extends ViewPart {
	 ...
	 */
	public static final String ID = "com.agritrace.edairy.desktop.install.views.SampleView";
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(viewer.getControl(), "com.agritrace.edairy.desktop.install.viewer");
		makeActions();
		hookContextMenu();
