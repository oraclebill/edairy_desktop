...
public class DairyLocationControllerTest extends AbstractSubModuleControllerTest<DairyLocationController> {
	...
	final ITextRidget phone = getController().getRidget(ITextRidget.class, DairyLocationController.RIDGET_ID_PHONE);
	...
	final IDateTextRidget dateOpened = getController().getRidget(IDateTextRidget.class,
	...
	final ITextRidget town = getController()
		.getRidget(ITextRidget.class, DairyLocationController.RIDGET_ID_PL_TOWN);
	...
	final ITextRidget sub = getController().getRidget(ITextRidget.class, DairyLocationController.RIDGET_ID_PL_SUB);
