...
import com.agritrace.edairy.desktop.ui.views.data.LocalDairyFactory;
...
public class LocalDairyViewController extends SubModuleController {
	...
	public LocalDairy copyBean(final Object source, final Object target) {
	    final LocalDairy from = source != null ? (LocalDairy) source : createWorkingCopy();
	    final LocalDairy to = target != null ? (LocalDairy) target : createWorkingCopy();
	...
	public boolean isChanged(Object source, Object target) {
	    final LocalDairy p1 = (LocalDairy) source;
	    final LocalDairy p2 = (LocalDairy) target;
    ...
    private final List<LocalDairy> input = LocalDairyFactory.createPersonList();

    @Override
    public void configureRidgets() {
	final String[] properties = new String[] { "id", "firstname", "lastname", "farm" };
	final String[] headers = new String[] { "ID", "First Name", "Last Name", "Farm" };
	...
	if (master != null) {
	    ...
	    master.bindToModel(new WritableList(input, LocalDairy.class), LocalDairy.class, properties, headers);
