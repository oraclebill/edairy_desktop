...
public class EDairyManagerApplication extends SwtApplication {
	...
	protected IApplicationNode createModel() {
		...
		NodeFactory
				.createSubModule(
						"edm.member.directory", "Member Directory", moduleNode, MemberSearchView.ID, MemberSearchViewController.class); //$NON-NLS-1$ //$NON-NLS-2$
		...
		NodeFactory
				.createSubModule(
						"edm.services.log", "Request Log", moduleServices, ServiceRequestLogView.ID, ServiceLogViewController.class); //$NON-NLS-1$ //$NON-NLS-2$
		NodeFactory.createSubModule(
				"edm.services.animalhealth", "Request Entry", moduleServices, VeterinaryRequestView.ID); //$NON-NLS-1$ //$NON-NLS-2$
		...
		NodeFactory.createSubModule(
				"edm.services.supplier.directory", "Supplier Directory", moduleDirectory, SupplierListView.ID); //, StaffInfoViewController.class); //$NON-NLS-1$ //$NON-NLS-2$
