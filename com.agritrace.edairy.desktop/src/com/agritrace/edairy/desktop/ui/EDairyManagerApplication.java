...
public class EDairyManagerApplication extends SwtApplication {
	...
	workarea.registerDefinition(subApp, "com.agritrace.edairy.desktop.manager.home"); //$NON-NLS-1$
	...
	subApp = new SubApplicationNode(new NavigationNodeId("com.agritrace.edairy.desktop.manager.main"), "Milk Operations"); //$NON-NLS-1$
	app.addChild(subApp);
	workarea.registerDefinition(subApp, "com.agritrace.edairy.desktop.manager.milk"); //$NON-NLS-1$
	...
	subApp = new SubApplicationNode(
		new NavigationNodeId("com.agritrace.edairy.desktop.manager.members"), "Membership Management"); //$NON-NLS-1$
	app.addChild(subApp);
	workarea.registerDefinition(subApp, "com.agritrace.edairy.desktop.manager.members"); //$NON-NLS-1$
	...
	// TOOLS TAB
	//
	subApp = new SubApplicationNode(new NavigationNodeId("com.agritrace.edairy.desktop.manager.ftools"), "Office Tools"); //$NON-NLS-1$
	app.addChild(subApp);
	workarea.registerDefinition(subApp, "com.agritrace.edairy.desktop.manager.ftools"); //$NON-NLS-1$
	...
	subApp = new SubApplicationNode(new NavigationNodeId("com.agritrace.edairy.desktop.manager.reports"), "Reports"); //$NON-NLS-1$
	app.addChild(subApp);
	workarea.registerDefinition(subApp, "com.agritrace.edairy.desktop.manager.reports"); //$NON-NLS-1$
	...
	subApp = new SubApplicationNode(new NavigationNodeId("com.agritrace.edairy.desktop.manager.administration"), "Admin"); //$NON-NLS-1$
	app.addChild(subApp);
	workarea.registerDefinition(subApp, "com.agritrace.edairy.desktop.manager.administration"); //$NON-NLS-1$
