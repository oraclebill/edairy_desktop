...
public class LocationInfoGroup extends Group {
	...
	{
		Composite addressArea = new Composite(parent, SWT.NO_BACKGROUND);
		GridLayout gl_addressArea = new GridLayout(2, false);
		...
		Label label_2 = new Label(addressArea, SWT.NONE);
		...
		Label label_3 = new Label(addressArea, SWT.NONE);
		...
		Label label_4 = new Label(addressArea, SWT.NONE);
		...
		Label label_5 = new Label(addressArea, SWT.NONE);
		...
		Label label_6 = new Label(addressArea, SWT.NONE);
...
//		divisionCombo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		Label label_7 = new Label(addressArea, SWT.NONE);
...
//		districtCombo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		Label label_8 = new Label(addressArea, SWT.NONE);
...
//		provinceCombo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		...
		Label label_9 = new Label(addressArea, SWT.NONE);
	...
	public LocationInfoGroup(Composite parent, int style) {
		...
		Composite addressArea = createAddressArea(this);
	}
	...
	public Text getTxtSection() {
		return txtSection;
	}

	public Text getTxtEstate() {
		return txtEstate;
	}

	public Text getTxtTown() {
		return txtTown;
	}

	public Text getTxtSubLocation() {
		return txtSubLocation;
	}

	public Combo getTxtLocation() {
		return txtLocation;
	}

	public Text getTxtPostalCode() {
		return txtPostalCode;
	}

	public Combo getDivisionCombo() {
		return divisionCombo;
	}

	public Combo getDistrictCombo() {
		return districtCombo;
	}

	public Combo getProvinceCombo() {
