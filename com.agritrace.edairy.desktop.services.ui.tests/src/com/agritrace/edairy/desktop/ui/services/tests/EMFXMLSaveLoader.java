...
public class EMFXMLSaveLoader {
     ...
     *            Load/Save options
     */
    private static void setOption(XMLResource resource, Map<String, Boolean> option) {
	...
	try {
	    ...
	    final Map options = resource.getDefaultSaveOptions();
	...
	try {
	    ...
	    final Map option = resource.getDefaultLoadOptions();
