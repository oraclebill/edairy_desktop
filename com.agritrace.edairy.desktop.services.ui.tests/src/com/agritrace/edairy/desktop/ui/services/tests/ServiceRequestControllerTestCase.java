...
public class ServiceRequestControllerTestCase extends
	...
	public void testFilterSection() {
		...
		// final ITextRidget startDate =
		// getController().getRidget(ITextRidget.class,
		...
		// final ITextRidget endDate =
		// getController().getRidget(ITextRidget.class,
		// ServiceRequestFilterSection.END_DATE);
		// assertEquals(endDate.getText(), ServiceUtils.getLastDayofMonth());
		//
		// // All type button
		// final IToggleButtonRidget allTypeBtn =
		// getController().getRidget(IToggleButtonRidget.class,
		// ServiceRequestFilterSection.REQUEST_TYPE_ALL);
		// assertTrue(allTypeBtn.isSelected());
		//
		// // Verternary (Request type), By defalut verternary button is
		// unchecked
		// final IToggleButtonRidget verterTypeBtn =
		// getController().getRidget(IToggleButtonRidget.class,
		...
		// final IToggleButtonRidget insemenitationTypeBtn =
		// getController().getRidget(IToggleButtonRidget.class,
		...
		// final ITableRidget masterTable =
		...
		// final IActionRidget apply =
		// getController().getRidget(IActionRidget.class,
