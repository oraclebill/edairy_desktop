...
--
-- Host: localhost    Database: dairydemo
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=644663 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29785 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vehicle` (
  ...
  `logbooknumber` varchar(60) NOT NULL,
...
-- Dump completed on 2010-12-08 12:44:30
