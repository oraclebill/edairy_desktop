...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		// hibernate.properties file in the root of
		// // the classpath.
		// // Another approach is setting the properties in the HbDataStore. To
		// do this comment out the
		// // following lines
		...
		//
		// hbds.setEPackages( new EPacakge[] {DairyPackage.eINSTANCE,
		// AccountPackage.eINSTANCE, ModelPackage.eINSTANCE,
		// TrackingPackage.eINSTANCE, RequestsPackage.eINSTANCE });
		// hbds.initialize();
		// sFactory = hbds.getSessionFactory();
		//
		// context.registerService(SessionFactory.class.getName(), sFactory, new
		// Hashtable());
