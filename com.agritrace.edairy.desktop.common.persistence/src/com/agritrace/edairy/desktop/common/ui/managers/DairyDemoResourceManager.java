...
public class DairyDemoResourceManager implements IDairyResourceManager {
	...
	public Dairy createDairyData() throws ParseException {
		...
		for (int i = 0; i < 20; i++) {
			...
			final Location memberLocation = createLocation("Joseph - " + i + "address", " ection" + i, "estate" + i,
					...
					"78532");
			member1.setMember(createFarmer("Joseph - " + i, "X", "Limuru", "609-356-3400" + i,
	...
	Membership randomOrNewMember(Dairy dairy) {
		...
		final int memberCount = dairy.getMemberships().size();
		if (memberCount > 2) {
			membership = dairy.getMemberships().get(new Random().nextInt(memberCount));
		} else {
			final Location farmLocation = createLocation("generated address", "generated section", "generated estate",
					"generated village", "generated sublocation", "generated location", "generated district",
					"generated division", "generated division", "generated postcode");
			membership = createMembership(
					new Date(),
					new Date(),
					createFarmer("Barry", "", "White", "1231231233", farmLocation, NO_CONTACTS,
