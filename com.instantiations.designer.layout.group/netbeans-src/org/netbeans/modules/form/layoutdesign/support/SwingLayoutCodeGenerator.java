...
public class SwingLayoutCodeGenerator {
    ...
    public void generateContainerLayout(Writer writer, LayoutComponent container,
            String contVarName, ComponentInfo infos[], boolean useLibrary)
        throws IOException
    {
    ...
    private void composeGroup(StringBuilder layout,
                              ...
                              boolean first, boolean last, String indent)
        throws IOException
    {
    ...
    private void fillGroup(StringBuilder layout, LayoutInterval interval,
        boolean first, boolean last, int groupAlignment, String indent) throws IOException {
        if (interval.isGroup()) {
