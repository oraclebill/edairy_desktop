...
//				AbstractMasterDetailsComposite.BIND_ID_TABLE);
		...
		textName = container.getRidget(ITextRidget.class,
...
//						from.getLocation().getMapLocation().getLongitude());
	...
	private void configureAddressTab(IRidgetContainer container,
		...
		textAddress.bindToModel(
				dairyLocation.getLocation().getPostalLocation(), "address");
		...
		section.bindToModel(dairyLocation.getLocation().getPostalLocation(),
				"section");
		...
		location.bindToModel(dairyLocation.getLocation().getPostalLocation(),
				"location");
		...
		district.bindToModel(dairyLocation.getLocation().getPostalLocation(),
				"district");
		...
		division.bindToModel(dairyLocation.getLocation().getPostalLocation(),
				"division");
		...
		postalCode.bindToModel(dairyLocation.getLocation().getPostalLocation(),
				"postalCode");
		...
		province.bindToModel(dairyLocation.getLocation().getPostalLocation(),
				"province");
