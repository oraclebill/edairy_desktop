...
public class RouteListDialogController extends AbstractWindowController {
	...
	public void configureRidgets() {
		...
		routeTable.bindToModel(this, "routeList", Route.class, new String[] { "name", "description", "code" },
		...
		addAction.addListener(new IActionListener() {
			...
			public void callback() {
				final AddRouteDialog dialog = new AddRouteDialog(new AddRouteDialogController(repo));
