...
public interface Employee extends Person {
	...
	/**
	 * Returns a string of the form "familyname (licenseno)".
	 * Used in vehicle edit dialog in the driver selection combo box.
	 * 
	 * NOT AUTOGENERATED - Do not delete this definition
	 */
