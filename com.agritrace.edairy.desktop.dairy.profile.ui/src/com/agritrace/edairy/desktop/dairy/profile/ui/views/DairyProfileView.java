...
//	final LocationInfoGroup locationInfoGroup = new LocationInfoGroup(top, SWT.NONE);
    ...
    private Group createAddress(Composite parent){
    	...
    	final Text txtAddress = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_ADDRESS);
    	...
    	final Text txtAddress2 = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_SECTION);
    	...
    	final Text estateAddress = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_ESTATE);
    	...
    	final Text txtVillage = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_VILLAGE);
    	...
    	final Text txtSubLocation = UIControlsFactory
    		.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_SUBLOCATION);
    	...
    	final Text txtLocation = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_LOCATION);
    	...
    	final Text txtDivision = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_DIVISION);
    	...
    	final Text txtDistrict = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_DISTRICT);
    	...
    	final Combo comboProvince = UIControlsFactory.createCombo(addressPanel, DairyProfileViewWidgetID.DAIRY_LOCATION_PROVINCE);
    	...
    	final Text txtPostal = UIControlsFactory.createText(addressPanel, SWT.BORDER, DairyProfileViewWidgetID.DAIRY_LOCATION_POSTALCODE);
