...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>tracking</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TrackingExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.tracking"));
				Farm root = TrackingFactory.eINSTANCE.createFarm();
