 ...
 * $Id$
 */
package com.agritrace.edairy.model.requests.requests.tests;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>requests</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RequestsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.requests"));
				AnimalHealthRequest root = RequestsFactory.eINSTANCE.createAnimalHealthRequest();
