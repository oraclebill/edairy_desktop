...
public class ServiceRequestResourceManager {
	...
	public static final String FILE_PATH = IDairyResourceManager.XMLDB_BASE
			+ "/servicerequests.xml";
	...
	private void createReq1() throws ParseException {
		final AnimalHealthRequest req = RequestsFactory.eINSTANCE
	...
	public void loadResources() {
		...
		final URI dairyResourceURI = URI
				.createFileURI(ServiceRequestResourceManager.FILE_PATH);
		serviceRequestResource = ResourceManager.INSTANCE
	...
	public <T extends EObject> List<T> getObjectsFromDairyModel(Class<T> type)
		...
		if (serviceRequestResource == null) {
			throw new CoreException(new Status(IStatus.ERROR,
					Activator.PLUGIN_ID, "can't load dairy modle"));
		}
