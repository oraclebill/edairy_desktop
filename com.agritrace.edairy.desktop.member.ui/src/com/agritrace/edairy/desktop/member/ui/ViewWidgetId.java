...
public class ViewWidgetId implements DialogConstants {
	...
	public static final String calendarButton = "calendarButton";

	public static final String calendarDate = "calendar";

	public static final String cancelButton = "cancel";

	public static final String canIdText = "canIdText";
	...
	public static final String driverCombo = "driverCombo";
	...
	public static final String memberInfo_memberNbr = "memberNbr";
	...
	public static final String milkEntryTable = "milkEntryTable";

	public static final String milkGroup = "milkGroup";
	...
	public static final String nprMissingCombo = "NPR Missing";
	public static final String okButton = "ok";
	public static final String PHONE_TEXT = "PHONE";
	public static final String photoLabel = "photoLabel";
	...
	public static final String totalLabel = "totalLabel";
