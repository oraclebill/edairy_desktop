...
public class CreateMemberView extends SubModuleView implements SelectionListener {
	...
	// //
	// final IObservableValue lstMembersObserveSelectionObserveWidget =
	// SWTObservables.observeSelection(lstMembers);
	// final IObservableValue txtNameTextObserveValue =
	// PojoObservables.observeValue(txtName, "text");
	// bindingContext.bindValue(lstMembersObserveSelectionObserveWidget,
	// txtNameTextObserveValue, null, null);
	// //
	...
	private Composite createMasterDetails(Composite parent) {
		...
		final MemberProfileWidget profileWidget = new MemberProfileWidget(profileComposite);
		...
		final MemberCollectionRecordsWidget collectionWidget = new MemberCollectionRecordsWidget(collectionComposite);
