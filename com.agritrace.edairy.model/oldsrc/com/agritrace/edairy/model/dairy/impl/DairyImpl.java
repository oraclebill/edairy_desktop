 ...
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getCollections <em>Collections</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DairyImpl extends CompanyImpl implements Dairy {
	...
	public EList<Route> getRoutes() {
		if (routes == null) {
			routes = new EObjectContainmentEList.Resolving<Route>(Route.class, this, DairyPackage.DAIRY__ROUTES);
		}
		return routes;
	}
	...
	public EList<DairyLocation> getBranchLocations() {
		if (branchLocations == null) {
			branchLocations = new EObjectContainmentEList.Resolving<DairyLocation>(DairyLocation.class, this, DairyPackage.DAIRY__BRANCH_LOCATIONS);
		}
	...
	public EList<CollectionJournal> getCollections() {
		if (collections == null) {
			collections = new EObjectContainmentEList.Resolving<CollectionJournal>(CollectionJournal.class, this, DairyPackage.DAIRY__COLLECTIONS);
		}
		return collections;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case DairyPackage.DAIRY__COLLECTIONS:
