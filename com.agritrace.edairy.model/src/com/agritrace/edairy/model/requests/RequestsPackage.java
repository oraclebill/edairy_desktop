...
public interface RequestsPackage extends EPackage {
	...
	/**
         * The meta object id for the '{@link com.agritrace.edairy.model.requests.RequestType <em>Request Type</em>}' enum.
         * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
         * Returns the meta object for the reference '{@link com.agritrace.edairy.model.requests.AnimalHealthRequest#getRequestingMember <em>Requesting Member</em>}'.
         * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
         * @return the meta object for the reference '<em>Requesting Member</em>'.
         * @see com.agritrace.edairy.model.requests.AnimalHealthRequest#getRequestingMember()
         * @see #getAnimalHealthRequest()
         * @generated
         */
	...
	/**
         * Returns the meta object for the attribute '{@link com.agritrace.edairy.model.requests.AnimalHealthRequest#getReportedProblem <em>Reported Problem</em>}'.
         * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
         * @return the meta object for the attribute '<em>Reported Problem</em>'.
         * @see com.agritrace.edairy.model.requests.AnimalHealthRequest#getReportedProblem()
         * @see #getAnimalHealthRequest()
         * @generated
         */
	...
	/**
         * Returns the meta object for the attribute '{@link com.agritrace.edairy.model.requests.AnimalHealthRequest#getDateHeatDetected <em>Date Heat Detected</em>}'.
         * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
         * @return the meta object for the attribute '<em>Date Heat Detected</em>'.
         * @see com.agritrace.edairy.model.requests.AnimalHealthRequest#getDateHeatDetected()
         * @see #getAnimalHealthRequest()
         * @generated
         */
	...
	/**
         * Returns the meta object for the attribute '{@link com.agritrace.edairy.model.requests.AnimalHealthRequest#getSecondTreatment <em>Second Treatment</em>}'.
         * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
         * @return the meta object for the attribute '<em>Second Treatment</em>'.
         * @see com.agritrace.edairy.model.requests.AnimalHealthRequest#getSecondTreatment()
         * @see #getAnimalHealthRequest()
         * @generated
         */
