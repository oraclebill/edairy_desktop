...
public class RequestsPackageImpl extends EPackageImpl implements RequestsPackage {
	...
	final RequestsPackageImpl theRequestsPackage = (RequestsPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RequestsPackageImpl ? EPackage.Registry.INSTANCE
		.get(eNS_URI) : new RequestsPackageImpl());
	...
	initEClass(animalHealthRequestEClass, AnimalHealthRequest.class, "AnimalHealthRequest", !IS_ABSTRACT,
		!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	initEAttribute(getAnimalHealthRequest_RequestId(), theModelPackage.getUniqueID(), "requestId", null, 0, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getAnimalHealthRequest_RequestingMember(), theDairyPackage.getMembership(), null,
		"requestingMember", null, 1, 1, AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getAnimalHealthRequest_Dairy(), theDairyPackage.getDairy(), null, "dairy", null, 1, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_Date(), ecorePackage.getEDate(), "date", null, 0, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_Type(), this.getRequestType(), "type", null, 0, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_ReportedProblem(), ecorePackage.getEString(), "reportedProblem", null, 0,
		1, AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getAnimalHealthRequest_ReportedAnimal(), theTrackingPackage.getRegisteredAnimal(), null,
		"reportedAnimal", null, 0, 1, AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
		!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_DateHeatDetected(), ecorePackage.getEDate(), "dateHeatDetected", null, 0,
		1, AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_FirstTreatment(), ecorePackage.getEDate(), "firstTreatment", null, 0, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_SecondTreatment(), ecorePackage.getEDate(), "secondTreatment", null, 0,
		1, AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEAttribute(getAnimalHealthRequest_ThirdTreatment(), ecorePackage.getEDate(), "thirdTreatment", null, 0, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
		IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getAnimalHealthRequest_Member(), theDairyPackage.getMembership(), null, "member", null, 1, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getAnimalHealthRequest_Farm(), theTrackingPackage.getFarm(), null, "farm", null, 1, 1,
		AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	initEReference(getAnimalHealthRequest_ReferredTo(), theDairyPackage.getSupplier(), null, "referredTo", null, 0,
		1, AnimalHealthRequest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
		IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
