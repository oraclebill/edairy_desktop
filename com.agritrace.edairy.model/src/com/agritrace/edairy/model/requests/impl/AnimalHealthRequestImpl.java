 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getRequestId
 * <em>Request Id</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getRequestingMember
 * <em>Requesting Member</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getDairy
 * <em>Dairy</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getDate
 * <em>Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getType
 * <em>Type</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getReportedProblem
 * <em>Reported Problem</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getReportedAnimal
 * <em>Reported Animal</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getDateHeatDetected
 * <em>Date Heat Detected</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getFirstTreatment
 * <em>First Treatment</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getSecondTreatment
 * <em>Second Treatment</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getThirdTreatment
 * <em>Third Treatment</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getMember
 * <em>Member</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getFarm
 * <em>Farm</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.requests.impl.AnimalHealthRequestImpl#getReferredTo
...
public class AnimalHealthRequestImpl extends EObjectImpl implements AnimalHealthRequest {
    ...
    /**
     * The cached value of the '{@link #getRequestingMember()
    ...
    /**
     * The default value of the '{@link #getReportedProblem()
    ...
    /**
     * The cached value of the '{@link #getReportedProblem()
     * <em>Reported Problem</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getReportedProblem()
    ...
    /**
     * The cached value of the '{@link #getReportedAnimal()
    ...
    /**
     * The default value of the '{@link #getDateHeatDetected()
    ...
    /**
     * The cached value of the '{@link #getDateHeatDetected()
     * <em>Date Heat Detected</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getDateHeatDetected()
    ...
    /**
     * The default value of the '{@link #getFirstTreatment()
    ...
    /**
     * The cached value of the '{@link #getFirstTreatment()
     * <em>First Treatment</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getFirstTreatment()
    ...
    /**
     * The default value of the '{@link #getSecondTreatment()
    ...
    /**
     * The cached value of the '{@link #getSecondTreatment()
     * <em>Second Treatment</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getSecondTreatment()
    ...
    /**
     * The default value of the '{@link #getThirdTreatment()
    ...
    /**
     * The cached value of the '{@link #getThirdTreatment()
     * <em>Third Treatment</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getThirdTreatment()
    ...
    /**
     * The cached value of the '{@link #getReferredTo() <em>Referred To</em>}'
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__REQUEST_ID,
	...
	if (requestingMember != null && requestingMember.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    RequestsPackage.ANIMAL_HEALTH_REQUEST__REQUESTING_MEMBER, oldRequestingMember,
			    requestingMember));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    RequestsPackage.ANIMAL_HEALTH_REQUEST__REQUESTING_MEMBER, oldRequestingMember, requestingMember));
	}
    }
	...
	if (dairy != null && dairy.eIsProxy()) {
	    final InternalEObject oldDairy = (InternalEObject) dairy;
	    dairy = (Dairy) eResolveProxy(oldDairy);
	    if (dairy != oldDairy) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    RequestsPackage.ANIMAL_HEALTH_REQUEST__DAIRY, oldDairy, dairy));
		}
	    }
	}
	return dairy;
	...
	final Dairy oldDairy = dairy;
	dairy = newDairy;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__DAIRY,
		    oldDairy, dairy));
	}
    }
	...
	date = newDate;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__DATE, oldDate,
		    date));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__TYPE, oldType,
		    type));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    RequestsPackage.ANIMAL_HEALTH_REQUEST__REPORTED_PROBLEM, oldReportedProblem, reportedProblem));
	}
    }
	...
	if (reportedAnimal != null && reportedAnimal.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    RequestsPackage.ANIMAL_HEALTH_REQUEST__REPORTED_ANIMAL, oldReportedAnimal, reportedAnimal));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    RequestsPackage.ANIMAL_HEALTH_REQUEST__DATE_HEAT_DETECTED, oldDateHeatDetected, dateHeatDetected));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    RequestsPackage.ANIMAL_HEALTH_REQUEST__FIRST_TREATMENT, oldFirstTreatment, firstTreatment));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    RequestsPackage.ANIMAL_HEALTH_REQUEST__SECOND_TREATMENT, oldSecondTreatment, secondTreatment));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    RequestsPackage.ANIMAL_HEALTH_REQUEST__THIRD_TREATMENT, oldThirdTreatment, thirdTreatment));
	}
    }
	...
	if (member != null && member.eIsProxy()) {
	    final InternalEObject oldMember = (InternalEObject) member;
	    member = (Membership) eResolveProxy(oldMember);
	    if (member != oldMember) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    RequestsPackage.ANIMAL_HEALTH_REQUEST__MEMBER, oldMember, member));
		}
	    }
	}
	return member;
	...
	final Membership oldMember = member;
	member = newMember;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__MEMBER,
		    oldMember, member));
	}
    }
	...
	if (farm != null && farm.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    RequestsPackage.ANIMAL_HEALTH_REQUEST__FARM, oldFarm, farm));
		}
	    }
	}
	return farm;
	...
	farm = newFarm;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__FARM, oldFarm,
		    farm));
	}
    }
	...
	if (referredTo != null && referredTo.eIsProxy()) {
		...
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
			    RequestsPackage.ANIMAL_HEALTH_REQUEST__REFERRED_TO, oldReferredTo, referredTo));
		}
	    }
	}
	return referredTo;
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, RequestsPackage.ANIMAL_HEALTH_REQUEST__REFERRED_TO,
		    oldReferredTo, referredTo));
	}
    }
	...
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__REPORTED_PROBLEM:
	    return REPORTED_PROBLEM_EDEFAULT == null ? reportedProblem != null : !REPORTED_PROBLEM_EDEFAULT
		    .equals(reportedProblem);
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__REPORTED_ANIMAL:
	    return reportedAnimal != null;
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__DATE_HEAT_DETECTED:
	    return DATE_HEAT_DETECTED_EDEFAULT == null ? dateHeatDetected != null : !DATE_HEAT_DETECTED_EDEFAULT
		    .equals(dateHeatDetected);
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__FIRST_TREATMENT:
	    return FIRST_TREATMENT_EDEFAULT == null ? firstTreatment != null : !FIRST_TREATMENT_EDEFAULT
		    .equals(firstTreatment);
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__SECOND_TREATMENT:
	    return SECOND_TREATMENT_EDEFAULT == null ? secondTreatment != null : !SECOND_TREATMENT_EDEFAULT
		    .equals(secondTreatment);
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__THIRD_TREATMENT:
	    return THIRD_TREATMENT_EDEFAULT == null ? thirdTreatment != null : !THIRD_TREATMENT_EDEFAULT
		    .equals(thirdTreatment);
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__MEMBER:
	    return member != null;
	case RequestsPackage.ANIMAL_HEALTH_REQUEST__FARM:
	    return farm != null;
