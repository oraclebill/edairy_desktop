 ...
 * <em><b>Rearing Mode</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum RearingMode implements Enumerator {
    /**
     * The '<em><b>GRAZE</b></em>' literal object. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #GRAZE_VALUE
     * @generated
    ...
    /**
     * The '<em><b>ZEROGRAZE</b></em>' literal object. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #ZEROGRAZE_VALUE
     * @generated
    ...
    /**
     * The '<em><b>PASTORALHERD</b></em>' literal object. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>GRAZE</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * The '<em><b>ZEROGRAZE</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * The '<em><b>PASTORALHERD</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>PASTORALHERD</b></em>' literal object isn't
     ...
     * @generated
     */
    private static final RearingMode[] VALUES_ARRAY = new RearingMode[] { GRAZE, ZEROGRAZE, PASTORALHERD, OTHER, };

    /**
     * A public read-only list of all the '<em><b>Rearing Mode</b></em>'
    ...
    /**
     * Returns the '<em><b>Rearing Mode</b></em>' literal with the specified
	...
	for (int i = 0; i < VALUES_ARRAY.length; ++i) {
	    final RearingMode result = VALUES_ARRAY[i];
	...
	case GRAZE_VALUE:
	    return GRAZE;
	case ZEROGRAZE_VALUE:
	    return ZEROGRAZE;
	case PASTORALHERD_VALUE:
	    return PASTORALHERD;
	case OTHER_VALUE:
	    return OTHER;
	}
