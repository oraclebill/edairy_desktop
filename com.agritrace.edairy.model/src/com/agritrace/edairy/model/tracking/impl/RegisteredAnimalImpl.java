 ...
 * <ul>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getAnimnalRegistrationId <em>Animnal Registration Id</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getGivenName <em>Given Name</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getGender <em>Gender</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getAnimalType <em>Animal Type</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getSireType <em>Sire Type</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getDateOfAcquisition <em>Date Of Acquisition</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getAcquisitionType <em>Acquisition Type</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getIdentifiers <em>Identifiers</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.tracking.impl.RegisteredAnimalImpl#getIdentifyingFeatures <em>Identifying Features</em>}</li>
...
public class RegisteredAnimalImpl extends EObjectImpl implements RegisteredAnimal {
	...
	/**
	 * The cached value of the '{@link #getSireType() <em>Sire Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSireType()
	 * @generated
	...
	public ReferenceAnimalType getSireType() {
		if (sireType != null && sireType.eIsProxy()) {
			InternalEObject oldSireType = (InternalEObject)sireType;
			sireType = (ReferenceAnimalType)eResolveProxy(oldSireType);
			if (sireType != oldSireType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TrackingPackage.REGISTERED_ANIMAL__SIRE_TYPE, oldSireType, sireType));
			}
		}
		return sireType;
	}
	 ...
	 * @generated
	 */
	public ReferenceAnimalType basicGetSireType() {
		return sireType;
	}
	...
	public void setSireType(ReferenceAnimalType newSireType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.REGISTERED_ANIMAL__SIRE_TYPE, oldSireType, sireType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TrackingPackage.REGISTERED_ANIMAL__SIRE_TYPE:
				if (resolve) return getSireType();
				return basicGetSireType();
