 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.tracking.impl.ReferenceAnimalTypeImpl#getAnimalTypeId
 * <em>Animal Type Id</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.tracking.impl.ReferenceAnimalTypeImpl#getSpecies
 * <em>Species</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.tracking.impl.ReferenceAnimalTypeImpl#getBreed
 * <em>Breed</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ReferenceAnimalTypeImpl extends EObjectImpl implements ReferenceAnimalType {
    /**
     * The default value of the '{@link #getAnimalTypeId()
    ...
    /**
     * The cached value of the '{@link #getAnimalTypeId()
     * <em>Animal Type Id</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getAnimalTypeId()
    ...
    /**
     * The default value of the '{@link #getSpecies() <em>Species</em>}'
    ...
    /**
     * The cached value of the '{@link #getSpecies() <em>Species</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getSpecies()
     * @generated
	...
	final long oldAnimalTypeId = animalTypeId;
	animalTypeId = newAnimalTypeId;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET,
		    TrackingPackage.REFERENCE_ANIMAL_TYPE__ANIMAL_TYPE_ID, oldAnimalTypeId, animalTypeId));
	}
    }
	...
	species = newSpecies;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.REFERENCE_ANIMAL_TYPE__SPECIES,
		    oldSpecies, species));
	}
    }
	...
	breed = newBreed;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.REFERENCE_ANIMAL_TYPE__BREED,
		    oldBreed, breed));
	}
    }
