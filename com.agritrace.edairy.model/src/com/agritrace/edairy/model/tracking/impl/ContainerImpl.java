 ...
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.tracking.impl.ContainerImpl#getContainerId
 * <em>Container Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.tracking.impl.ContainerImpl#getOwner
 * <em>Owner</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.tracking.impl.ContainerImpl#getCapacity
 * <em>Capacity</em>}</li>
 * <li>{@link com.agritrace.edairy.model.tracking.impl.ContainerImpl#getType
 * <em>Type</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.tracking.impl.ContainerImpl#getMeasureType
 * <em>Measure Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ContainerImpl extends EObjectImpl implements Container {
    ...
    /**
     * The default value of the '{@link #getMeasureType() <em>Measure Type</em>}
     * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getMeasureType()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getMeasureType() <em>Measure Type</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getMeasureType()
     * @generated
	...
	final String oldContainerId = containerId;
	containerId = newContainerId;
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.CONTAINER__CONTAINER_ID,
	...
	if (owner != null && owner.eIsProxy()) {
	    ...
	    if (owner != oldOwner) {
		if (eNotificationRequired()) {
		    eNotify(new ENotificationImpl(this, Notification.RESOLVE, TrackingPackage.CONTAINER__OWNER,
			    oldOwner, owner));
		}
	    }
	}
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.CONTAINER__CAPACITY, oldCapacity,
		    capacity));
	}
    }
	...
	final ContainerType oldType = type;
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.CONTAINER__MEASURE_TYPE,
		    oldMeasureType, measureType));
	}
    }
