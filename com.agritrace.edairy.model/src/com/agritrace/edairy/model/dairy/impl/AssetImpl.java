 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getAssetId <em>
 * Asset Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getTagType <em>Tag
 * Type</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getTagValue <em>
 * Tag Value</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getDateAcquired
 * <em>Date Acquired</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getDamageDate <em>
 * Damage Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getDamageDescription
 * <em>Damage Description</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getDateDisposed
 * <em>Date Disposed</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getDisposalReason
 * <em>Disposal Reason</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.AssetImpl#getDisposalWitness
...
public class AssetImpl extends EObjectImpl implements Asset {
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ASSET__DATE_ACQUIRED, oldDateAcquired,
		    dateAcquired));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ASSET__DAMAGE_DATE, oldDamageDate,
		    damageDate));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ASSET__DAMAGE_DESCRIPTION,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ASSET__DATE_DISPOSED, oldDateDisposed,
		    dateDisposed));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ASSET__DISPOSAL_REASON,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.ASSET__DISPOSAL_WITNESS,
