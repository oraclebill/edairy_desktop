 ...
 * <ul>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getSupplierId <em>Supplier Id</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getCategories <em>Categories</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getPublicDescription <em>Public Description</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getRegistrationDate <em>Registration Date</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getExpirationDate <em>Expiration Date</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getRating <em>Rating</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.impl.SupplierImpl#getContact <em>Contact</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SupplierImpl extends PersonImpl implements Supplier {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.SUPPLIER__NAME, oldName, name));
	}
	...
	public Person getContact() {
		if (contact != null && contact.eIsProxy()) {
			...
			if (contact != oldContact) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DairyPackage.SUPPLIER__CONTACT, oldContact, contact));
			}
		}
		return contact;
	}
	...
	public void setContact(Person newContact) {
		...
		contact = newContact;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.SUPPLIER__CONTACT, oldContact, contact));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DairyPackage.SUPPLIER__NAME:
				return getName();
			case DairyPackage.SUPPLIER__CONTACT:
