 ...
 * <ul>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.EmployeeImpl#getId <em>Id
 * </em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.EmployeeImpl#getStartDate
 * <em>Start Date</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.EmployeeImpl#getJobFunction
 * <em>Job Function</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.EmployeeImpl#getNationalId
 * <em>National Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.EmployeeImpl#getNhifNumber
 * <em>Nhif Number</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.EmployeeImpl#getNssfNumber
 * <em>Nssf Number</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class EmployeeImpl extends PersonImpl implements Employee {
    ...
    /**
     * The default value of the '{@link #getJobFunction() <em>Job Function</em>}
     * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getJobFunction()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getJobFunction() <em>Job Function</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getJobFunction()
     * @generated
    ...
    /**
     * The default value of the '{@link #getNationalId() <em>National Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getNationalId()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getNationalId() <em>National Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getNationalId()
     * @generated
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.EMPLOYEE__START_DATE, oldStartDate,
		    startDate));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.EMPLOYEE__JOB_FUNCTION, oldJobFunction,
		    jobFunction));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.EMPLOYEE__NATIONAL_ID, oldNationalId,
		    nationalId));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.EMPLOYEE__NHIF_NUMBER, oldNhifNumber,
		    nhifNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.EMPLOYEE__NSSF_NUMBER, oldNssfNumber,
		    nssfNumber));
	}
    }
