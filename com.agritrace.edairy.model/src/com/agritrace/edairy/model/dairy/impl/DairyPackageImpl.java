...
public class DairyPackageImpl extends EPackageImpl implements DairyPackage {
	...
	public EReference getCollectionJournalLine_ValidatedMember() {
		return (EReference)collectionJournalLineEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getCollectionJournalLine_OffRoute() {
		return (EAttribute)collectionJournalLineEClass.getEStructuralFeatures().get(6);
	}
	...
	public EReference getCollectionJournalLine_From() {
		return (EReference)collectionJournalLineEClass.getEStructuralFeatures().get(7);
	}
	...
	public EAttribute getDairy_RegistrationNumber() {
		return (EAttribute)dairyEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getSupplier_Contact() {
		return (EReference)supplierEClass.getEStructuralFeatures().get(9);
	}
	...
	public void createPackageContents() {
		...
		createEReference(supplierEClass, SUPPLIER__CONTACT);
	...
	public void initializePackageContents() {
		...
		initEReference(getSupplier_Contact(), theModelPackage.getPerson(), null, "contact", null, 1, 1, Supplier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
