 ...
 * <em><b>Dairy</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getRegistrationNumber
 * <em>Registration Number</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getNhifNumber <em>
 * Nhif Number</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getNssfNumber <em>
 * Nssf Number</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getFederalPin <em>
 * Federal Pin</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getLicenseEffectiveDate
 * <em>License Effective Date</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getLicenseExpirationDate
 * <em>License Expiration Date</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getRoutes <em>
 * Routes</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getVehicles <em>
 * Vehicles</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getEmployees <em>
 * Employees</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getMemberships
 * <em>Memberships</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getBranchLocations
 * <em>Branch Locations</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getCollectionJournals
 * <em>Collection Journals</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getSuppliers <em>
 * Suppliers</em>}</li>
 * <li>
 * {@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getAnimalHealthRequests
 * <em>Animal Health Requests</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getDairyId <em>
 * Dairy Id</em>}</li>
 * <li>{@link com.agritrace.edairy.model.dairy.impl.DairyImpl#getDairyBins <em>
 * Dairy Bins</em>}</li>
 * </ul>
 * </p>
 * 
...
public class DairyImpl extends CompanyImpl implements Dairy {
    /**
     * The default value of the '{@link #getRegistrationNumber()
    ...
    /**
     * The cached value of the '{@link #getRegistrationNumber()
     * <em>Registration Number</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getRegistrationNumber()
    ...
    /**
     * The default value of the '{@link #getNhifNumber() <em>Nhif Number</em>}'
    ...
    /**
     * The cached value of the '{@link #getNhifNumber() <em>Nhif Number</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getNhifNumber()
     * @generated
    ...
    /**
     * The default value of the '{@link #getNssfNumber() <em>Nssf Number</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getNssfNumber()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getNssfNumber() <em>Nssf Number</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getNssfNumber()
     * @generated
    ...
    /**
     * The default value of the '{@link #getFederalPin() <em>Federal Pin</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getFederalPin()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getFederalPin() <em>Federal Pin</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getFederalPin()
     * @generated
    ...
    /**
     * The default value of the '{@link #getLicenseEffectiveDate()
     * <em>License Effective Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getLicenseEffectiveDate()
     * <em>License Effective Date</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getLicenseEffectiveDate()
    ...
    /**
     * The default value of the '{@link #getLicenseExpirationDate()
     * <em>License Expiration Date</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getLicenseExpirationDate()
     * <em>License Expiration Date</em>}' attribute. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @see #getLicenseExpirationDate()
    ...
    /**
     * The cached value of the '{@link #getVehicles() <em>Vehicles</em>}'
     * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getVehicles()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getEmployees() <em>Employees</em>}'
     * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getEmployees()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getMemberships() <em>Memberships</em>}'
     * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getMemberships()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getBranchLocations()
     * <em>Branch Locations</em>}' containment reference list. <!--
    ...
    /**
     * The cached value of the '{@link #getCollectionJournals()
     * <em>Collection Journals</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getSuppliers() <em>Suppliers</em>}'
    ...
    /**
     * The cached value of the '{@link #getAnimalHealthRequests()
     * <em>Animal Health Requests</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    /**
     * The default value of the '{@link #getDairyId() <em>Dairy Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDairyId()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDairyId() <em>Dairy Id</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDairyId()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getDairyBins() <em>Dairy Bins</em>}'
     * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getDairyBins()
     * @generated
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY__REGISTRATION_NUMBER,
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY__NHIF_NUMBER, oldNhifNumber,
		    nhifNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY__NSSF_NUMBER, oldNssfNumber,
		    nssfNumber));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY__FEDERAL_PIN, oldFederalPin,
		    federalPin));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY__LICENSE_EFFECTIVE_DATE,
		    oldLicenseEffectiveDate, licenseEffectiveDate));
	}
    }
	...
	if (eNotificationRequired()) {
	    eNotify(new ENotificationImpl(this, Notification.SET, DairyPackage.DAIRY__LICENSE_EXPIRATION_DATE,
		    oldLicenseExpirationDate, licenseExpirationDate));
	}
    }
	...
	if (memberships == null) {
	    memberships = new EObjectContainmentEList<Membership>(Membership.class, this,
		    DairyPackage.DAIRY__MEMBERSHIPS);
	}
	return memberships;
    }
	...
	if (branchLocations == null) {
	    branchLocations = new EObjectContainmentEList<DairyLocation>(DairyLocation.class, this,
		    DairyPackage.DAIRY__BRANCH_LOCATIONS);
	}
	...
	if (collectionJournals == null) {
	    collectionJournals = new EObjectContainmentEList<CollectionJournal>(CollectionJournal.class, this,
		    DairyPackage.DAIRY__COLLECTION_JOURNALS);
	}
	...
	if (animalHealthRequests == null) {
	    animalHealthRequests = new EObjectContainmentEList<AnimalHealthRequest>(AnimalHealthRequest.class, this,
		    DairyPackage.DAIRY__ANIMAL_HEALTH_REQUESTS);
	}
	...
	if (dairyBins == null) {
	    dairyBins = new EObjectContainmentEList<DairyContainer>(DairyContainer.class, this,
		    DairyPackage.DAIRY__DAIRY_BINS);
	}
	return dairyBins;
    }
	...
	switch (featureID) {
	case DairyPackage.DAIRY__REGISTRATION_NUMBER:
	    return REGISTRATION_NUMBER_EDEFAULT == null ? registrationNumber != null : !REGISTRATION_NUMBER_EDEFAULT
	...
	case DairyPackage.DAIRY__LICENSE_EFFECTIVE_DATE:
	    return LICENSE_EFFECTIVE_DATE_EDEFAULT == null ? licenseEffectiveDate != null
		    : !LICENSE_EFFECTIVE_DATE_EDEFAULT.equals(licenseEffectiveDate);
	case DairyPackage.DAIRY__LICENSE_EXPIRATION_DATE:
	    return LICENSE_EXPIRATION_DATE_EDEFAULT == null ? licenseExpirationDate != null
		    : !LICENSE_EXPIRATION_DATE_EDEFAULT.equals(licenseExpirationDate);
	case DairyPackage.DAIRY__ROUTES:
