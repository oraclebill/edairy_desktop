 ...
 * <ul>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getTransactionId <em>Transaction Id</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getTransactionType <em>Transaction Type</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getSoure <em>Soure</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getAmount <em>Amount</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.agritrace.edairy.model.dairy.account.impl.AccountTransactionImpl#getTransactionDate <em>Transaction Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AccountTransactionImpl extends EObjectImpl implements AccountTransaction {
	...
	public void setSoure(String newSoure) {
		String oldSoure = soure;
		soure = newSoure;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccountPackage.ACCOUNT_TRANSACTION__SOURE, oldSoure, soure));
	}
