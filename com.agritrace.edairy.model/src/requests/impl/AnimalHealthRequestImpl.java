 ...
 * <ul>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getRequestId <em>Request Id</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getRequestingMember <em>Requesting Member</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getDairy <em>Dairy</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getDate <em>Date</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getType <em>Type</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getReportedProblem <em>Reported Problem</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getReportedAnimal <em>Reported Animal</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getDateHeatDetected <em>Date Heat Detected</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getFirstTreatment <em>First Treatment</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getSecondTreatment <em>Second Treatment</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getThirdTreatment <em>Third Treatment</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getMember <em>Member</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getFarm <em>Farm</em>}</li>
 *   <li>{@link requests.impl.AnimalHealthRequestImpl#getReferredTo <em>Referred To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
