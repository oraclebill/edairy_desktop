 ...
 * <ul>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getProvince <em>Province</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getDivision <em>Division</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getDistrict <em>District</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getSubLocation <em>Sub Location</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getVillage <em>Village</em>}</li>
 *   <li>{@link edairy.model.impl.PostalLocationImpl#getPostalCode <em>Postal Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PostalLocationImpl extends LocationImpl implements PostalLocation {
	/**
