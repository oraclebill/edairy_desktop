...
import edairy.model.dairy.Dairy;
...
import edairy.model.dairy.Workstation;
 ...
 * <ul>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getNhifNumber <em>Nhif Number</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getNssfNumber <em>Nssf Number</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getFederalPin <em>Federal Pin</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getWorkstations <em>Workstations</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getRoutes <em>Routes</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getVehicles <em>Vehicles</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getEmployees <em>Employees</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getSessions <em>Sessions</em>}</li>
 *   <li>{@link edairy.model.dairy.impl.DairyImpl#getMemberships <em>Memberships</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DairyImpl extends edairy.model.tracking.impl.DairyImpl implements Dairy {
	/**
	...
	public EList<RouteDefinition> getRoutes() {
		if (routes == null) {
			routes = new EObjectContainmentEList<RouteDefinition>(RouteDefinition.class, this, DairyPackage.DAIRY__ROUTES);
		}
		return routes;
	}
	...
	public EList<Session> getSessions() {
		if (sessions == null) {
			sessions = new EObjectContainmentEList<Session>(Session.class, this, DairyPackage.DAIRY__SESSIONS);
		}
		return sessions;
	}
