	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.MAP_LOCATION: {
				...
				if (result == null) result = caseLocation(mapLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.POSTAL_LOCATION: {
				...
				if (result == null) result = caseLocation(postalLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.STATUTORY_LOCATION: {
				...
				if (result == null) result = caseLocation(statutoryLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.DESCRIPTIVE_LOCATION: {
				...
				if (result == null) result = caseLocation(descriptiveLocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
