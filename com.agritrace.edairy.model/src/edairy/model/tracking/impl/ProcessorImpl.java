 ...
 * <ul>
 *   <li>{@link edairy.model.tracking.impl.ProcessorImpl#getRegistrationNumber <em>Registration Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProcessorImpl extends CompanyImpl implements Processor {
	/**
	...
	protected EClass eStaticClass() {
		return TrackingPackage.Literals.PROCESSOR;
	}
	...
	public void setRegistrationNumber(String newRegistrationNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrackingPackage.PROCESSOR__REGISTRATION_NUMBER, oldRegistrationNumber, registrationNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TrackingPackage.PROCESSOR__REGISTRATION_NUMBER:
