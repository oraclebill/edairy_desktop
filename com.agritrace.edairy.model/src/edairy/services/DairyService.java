 ...
 * <ul>
 *   <li>{@link edairy.services.DairyService#getRoutes <em>Routes</em>}</li>
 *   <li>{@link edairy.services.DairyService#getSessions <em>Sessions</em>}</li>
 *   <li>{@link edairy.services.DairyService#getVehicles <em>Vehicles</em>}</li>
 *   <li>{@link edairy.services.DairyService#getEmployees <em>Employees</em>}</li>
 *   <li>{@link edairy.services.DairyService#getContainers <em>Containers</em>}</li>
 * </ul>
 * </p>
 *
 * @see edairy.services.ServicesPackage#getDairyService()
 * @model
 * @generated
 */
public interface DairyService extends EObject {
	 ...
	 * @see #setRoutes(EList)
	 * @see edairy.services.ServicesPackage#getDairyService_Routes()
	...
	/**
	 * Sets the value of the '{@link edairy.services.DairyService#getRoutes <em>Routes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edairy.services.ServicesPackage#getDairyService_Sessions()
	 * @model required="true" many="false" transient="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edairy.services.DairyService#getSessions <em>Sessions</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edairy.services.ServicesPackage#getDairyService_Vehicles()
	 * @model required="true" many="false" transient="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edairy.services.DairyService#getVehicles <em>Vehicles</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edairy.services.ServicesPackage#getDairyService_Employees()
	 * @model required="true" many="false" transient="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edairy.services.DairyService#getEmployees <em>Employees</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edairy.services.ServicesPackage#getDairyService_Containers()
	 * @model required="true" many="false" transient="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edairy.services.DairyService#getContainers <em>Containers</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
