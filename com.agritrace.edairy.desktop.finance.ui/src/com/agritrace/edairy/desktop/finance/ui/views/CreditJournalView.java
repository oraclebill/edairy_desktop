...
public class CreditJournalView extends ViewPart {
    ...
    private final List<CreditRecord> input = CreditRecordFactory.createCreditRecords();
	...
	final Group upperPanel = new Group(parent, SWT.NULL);
	...
	final Combo storeTypeBox = new Combo(upperPanel, SWT.NULL | SWT.READ_ONLY);
	storeTypeBox.setItems(new String[] { "Store", "Vaterinary", "Other" });
	storeTypeBox.select(0);
	storeTypeBox.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));

	final Combo locationBox = new Combo(upperPanel, SWT.NULL | SWT.READ_ONLY);
	locationBox.setItems(new String[] { "Route 2 - Ngecha", "Route 3 - Kelly" });
	locationBox.select(0);
	locationBox.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, false));

	final Label dateLabel = new Label(upperPanel, SWT.NULL);
	dateLabel.setText("Date:");

	dateField = new Text(upperPanel, SWT.BORDER | SWT.SINGLE | SWT.READ_ONLY);
	...
	final Composite middlePanel = new Composite(parent, SWT.NULL);
	middlePanel.setLayout(new GridLayout(3, false));
	middlePanel.setLayoutData(new GridData(SWT.BEGINNING, SWT.FILL, true, false));

	final Label referenceNumber = new Label(middlePanel, SWT.NULL);
	referenceNumber.setText("Reference #");

	final Text referenceText = new Text(middlePanel, SWT.BORDER);
	referenceText.setLayoutData(new GridData(SWT.BEGINNING, SWT.FILL, false, false, 2, 1));
	referenceText.setTextLimit(20);
	referenceText.setText("V-4599887");

	final Label recordLabel = new Label(middlePanel, SWT.NULL);
	recordLabel.setText("Record #");

	final Text recordLabelText = new Text(middlePanel, SWT.BORDER);
	recordLabelText.setLayoutData(new GridData(SWT.BEGINNING, SWT.FILL, false, false, 2, 1));
	recordLabelText.setTextLimit(5);
	recordLabelText.setText("2");

	final Label memberNumber = new Label(middlePanel, SWT.NULL);
	memberNumber.setText("Member #");

	final Text memberText = new Text(middlePanel, SWT.BORDER);
	memberText.setLayoutData(new GridData(SWT.BEGINNING, SWT.FILL, false, false, 2, 1));
	memberText.setTextLimit(20);
	memberText.setText("#45678");

	final Label memberNumberAddressLabel = new Label(middlePanel, SWT.NULL);
	memberNumberAddressLabel.setText("");

	final Text memberAddressText = new Text(middlePanel, SWT.BORDER);
	final GridData gd = new GridData(SWT.BEGINNING, SWT.FILL, true, false, 2, 1);
	gd.widthHint = 200;
	...
	final Label amountLabel = new Label(middlePanel, SWT.NULL);
	amountLabel.setText("Amount");

	final Text amountText = new Text(middlePanel, SWT.BORDER);
	amountText.setLayoutData(new GridData(SWT.BEGINNING, SWT.FILL, false, false, 2, 1));
	amountText.setTextLimit(20);
	amountText.setText("90");

	final Button addButton = new Button(middlePanel, SWT.PUSH);
