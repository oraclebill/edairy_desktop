...
public class TransactionBatchEntryDialogController extends AbstractWindowController {
	...
	private static final String[] LIST_PROPERTY_NAMES = {
		"id", "date", "source", "referenceNumber", "member", "amount"
	};
	
	private static final String[] LIST_COLUMN_HEADERS = {
	...
	public void configureRidgets() {
		...
		IMasterDetailsRidget master = getRidget(IMasterDetailsRidget.class, "master");
		master.setDelegate(new TransactionBatchEntryDelegate());
		List<AccountTransaction> transactionList = (List<AccountTransaction>) getContext("transaction-list");
		if (transactionList != null ) {
			master.bindToModel(
					new WritableList(transactionList, AccountTransaction.class), 
